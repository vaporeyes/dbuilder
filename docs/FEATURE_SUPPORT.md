...
- Platform-specific installers remain open, while default configuration asset bundling, app icons and metadata, release scripts, and packaged-output smoke checks are in place.
