...
- Current verified baseline: `scripts/verify.sh` passes 6962 tests.
...
- [x] Port preferences categories and persistence.
  ...
  - [x] Persist and apply UDB-style 3D move speed preference.
  ...
  - [x] Persist and apply UDB-style synchronized thing editing preference.
  - [x] Persist and apply UDB-style auto-draw-on-edit preference.
...
- [x] Add round-trip tests using maps from Doom, Doom II, Heretic, Hexen, Boom, MBF, ZDoom, and GZDoom formats.
...
- [ ] Port edit mode lifecycle behavior.
  ...
  - [x] Add UDB-style edit mode switch ordering and volatile-mode lifecycle planning.
...
- [x] Port undo manager behavior fully.
  ...
  - [x] Add UDB-style undo and redo status text planning for single and multi-level operations.
...
- [ ] Port stair builder behavior fully.
  ...
  - [x] Add UDB-style stair sector builder engage preflight and initial form flags.
...
- [ ] Port sound propagation editing behavior fully.
  ...
  - [x] Match UDB sound environment warnings-only filtering at environment level.
  - [x] Match UDB sound environment warnings-only checkbox count and enablement state.
  - [x] Model UDB sound environment panel highlight and selection toggles.
...
- [ ] Port dockers and tabbed dock panels.
  ...
  - [x] Add tested active-tab resolution for tabbed docker layout groups.
  - [x] Add tested docker show-state planning for command aliases and active tabs.
...
- [ ] Port renderer 2D parity.
  ...
  - [x] Add UDB-style 2D renderer brightness color planning.
  - [x] Add UDB-style 2D renderer extra-floor flag planning.
  - [x] Add UDB-style 2D sector plotting operation planning.
  - [x] Add UDB-style 2D plot line draw planning.
  - [x] Add UDB-style 2D linedef segment and normal indicator planning.
  - [x] Add UDB-style 2D linedef set plotting planning.
  ...
  - [x] Add UDB-style 2D text viewport culling surface.
...
- [ ] Port renderer 3D parity.
  ...
  - [x] Add UDB-style 3D geometry initial render-state planning.
  ...
  - [x] Add UDB-style 3D translucent model pass planning.
  - [x] Add UDB-style 3D thing cage pass planning.
  - [x] Add UDB-style 3D visual vertices pass planning.
  - [x] Add UDB-style 3D slope handles pass planning.
  - [x] Add UDB-style 3D event lines pass planning.
  ...
  - [x] Add UDB-style 3D slope handle render detail planning.
  ...
  - [x] Add UDB-style 3D translucent thing ordering and blend planning.
  - [x] Add UDB-style 3D thing position matrix strategy planning.
  ...
  - [x] Add UDB-style 3D sky render detail planning.
  - [x] Add UDB-style 3D thing dynamic lit-color planning.
  - [x] Add UDB-style 3D sector geometry collection planning.
  - [x] Add UDB-style 3D thing geometry collection planning.
  ...
  - [x] Add UDB-style 3D translucent thing draw-state planning.
...
- [ ] Port render passes and layers.
  ...
  - [x] Add persisted UDB-style light radii helper setting and 2D thing-mode radius rings.
  - [x] Parse UDB-style SNDINFO ambient sound records and editor radius data.
  - [x] Add persisted UDB-style sound radii helper setting and 2D thing-mode radius rings.
  ...
  - [x] Add UDB-style 2D presentation render-session start and finish planning.
  - [x] Add UDB-style 2D presentation surface redraw operation planning.
  ...
  - [x] Add UDB-style core render layer enum underlying type.
...
- [x] Port texture handling and lifecycle.
  ...
  - [x] Add UDB-style cube map face enum underlying type.
  ...
  - [x] Add UDB-style render-device texture unit validation planning.
  ...
  - [x] Add UDB-style cube texture operation face validation.
...
- [ ] Add screenshot and pixel-level regression tests for key render states.
  ...
  - [x] Add pixel-level regression coverage for Things mode presentation stack ordering.
  - [x] Add pixel-level regression coverage for Automap mode presentation stack ordering.
  - [x] Add pixel-level regression coverage for quality-display standard presentation.
  - [x] Add pixel-level regression coverage for 3D translucent alpha and additive geometry ordering.
  - [x] Add pixel-level regression coverage for 3D translucent alpha and additive thing ordering.
  - [x] Add pixel-level regression coverage for 3D model masked and translucent ordering.
  - [x] Add pixel-level regression coverage for neighboring zoomed-out thing marker culling.
  - [x] Add pixel-level regression coverage for surface desaturation draw-state reset.
...
- [ ] Port slopes visual editing.
  ...
  - [x] Preserve highlighted slope handle and old smart pivot after visual clear-selection.
- [x] Port model and voxel display.
  ...
  - [x] Persist and apply UDB-style stitch range preference for dragged vertex merging.
  - [x] Persist and apply UDB-style mouse selection threshold for drag activation.
  - [x] Persist and apply UDB-style classic auto-clear selection preference.
  - [x] Persist and apply UDB-style visual-mode clear-selection preference.
  - [x] Persist and apply UDB-style edit-new-thing preference after inserting things.
  - [x] Persist and apply UDB-style edit-new-sector preference after drawing sectors.
...
- [x] Port all map error checks.
  ...
  - [x] Match UDB exact endpoint checks for duplicate overlapping linedefs.
  ...
  - [x] Match UDB unclosed-sector selected-result description text.
  - [x] Match UDB invalid-sector selected-result description text.
...
- [x] Add API compatibility tests for common UDBScript scripts.
  ...
  - [x] Add UDBScript compatibility coverage for the bundled Logic Assertions workflow.
...
- [x] Add unit tests for every parser and serializer.
  - [x] Add explicit coverage inventory for current parser, reader, writer, and serializer test ownership.
