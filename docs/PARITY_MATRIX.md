...
| `Source/Core/IO` | partial | `DBuilder.IO` | WAD and map IO exist, including static format constraints before saves and bounded configured-map-lump find/remove helpers. Full stream, conversion, and save semantics remain. |
