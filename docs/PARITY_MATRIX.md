...
| `Source/Core/Controls` | partial | `DBuilder.Editor` | Avalonia dialogs exist for selected workflows only. Argument property editors and configured universal field rows now use universal handler metadata for boolean and enum-backed choices. |
