...
| `Source/Core/Data` | partial | `DBuilder.IO` | Resource manager and data-location metadata exist, including resource-list serialization, duplicate combination, display names, palette lookup, main colormap lookup, named colormap lookup, and colormap texture-name enumeration. Full UDB DataManager parity is incomplete. |
