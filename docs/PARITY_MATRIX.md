...
| `Source/Core/Windows` | partial | `DBuilder.Editor` | Selected windows exist, including basic grid setup, go-to-coordinates and About dialogs. Full UDB dialog set remains. |
