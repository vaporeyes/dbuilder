...
| `Source/Core/Editing` | partial | `DBuilder.Editor`, `DBuilder.Map`, `DBuilder.IO` | Selected editing workflows and UI-independent things filter evaluation exist. Full edit-mode lifecycle and things filter UI integration remain. |
