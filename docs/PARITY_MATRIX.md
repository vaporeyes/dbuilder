...
| `Source/Core/Data` | partial | `DBuilder.IO` | Resource manager and data-location metadata exist, including resource-list serialization, duplicate combination, display names, palette lookup, main colormap lookup, and named colormap lookup. Full UDB DataManager parity is incomplete. |
