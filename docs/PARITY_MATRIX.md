...
| `Source/Core/Data` | partial | `DBuilder.IO` | Resource manager and data-location metadata exist, including resource-list serialization, duplicate combination, and display names. Full UDB DataManager parity is incomplete. |
