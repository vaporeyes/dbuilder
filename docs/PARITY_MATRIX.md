...
| `Source/Core/Windows` | partial | `DBuilder.Editor` | Selected windows exist, including basic grid setup and go-to-coordinates dialogs. Full UDB dialog set remains. |
