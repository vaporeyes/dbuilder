...
public sealed class ColorCollection
{
    ...
    public const int NUM_THING_COLORS = NumThingColors;
    public const int THING_COLORS_OFFSET = ThingColorsOffset;
    ...
    public const int BACKGROUND = BackgroundIndex;
    public const int VERTICES = VerticesIndex;
    public const int LINEDEFS = LinedefsIndex;
    public const int MODELWIRECOLOR = ModelWireColorIndex;
    public const int INFOLINECOLOR = InfoLineColorIndex;
    public const int HIGHLIGHT = HighlightIndex;
    public const int SELECTION = SelectionIndex;
    public const int INDICATION = IndicationIndex;
    public const int GRID = GridIndex;
    public const int GRID64 = Grid64Index;
    public const int CROSSHAIR3D = Crosshair3DIndex;
    public const int HIGHLIGHT3D = Highlight3DIndex;
    public const int SELECTION3D = Selection3DIndex;
    public const int SCRIPTBACKGROUND = ScriptBackgroundIndex;
    public const int LINENUMBERS = LineNumbersIndex;
    public const int PLAINTEXT = PlainTextIndex;
    public const int COMMENTS = CommentsIndex;
    public const int KEYWORDS = KeywordsIndex;
    public const int LITERALS = LiteralsIndex;
    public const int CONSTANTS = ConstantsIndex;
    public const int THINGCOLOR00 = ThingColor00Index;
    public const int THINGCOLOR01 = ThingColor00Index + 1;
    public const int THINGCOLOR02 = ThingColor00Index + 2;
    public const int THINGCOLOR03 = ThingColor00Index + 3;
    public const int THINGCOLOR04 = ThingColor00Index + 4;
    public const int THINGCOLOR05 = ThingColor00Index + 5;
    public const int THINGCOLOR06 = ThingColor00Index + 6;
    public const int THINGCOLOR07 = ThingColor00Index + 7;
    public const int THINGCOLOR08 = ThingColor00Index + 8;
    public const int THINGCOLOR09 = ThingColor00Index + 9;
    public const int THINGCOLOR10 = ThingColor00Index + 10;
    public const int THINGCOLOR11 = ThingColor00Index + 11;
    public const int THINGCOLOR12 = ThingColor00Index + 12;
    public const int THINGCOLOR13 = ThingColor00Index + 13;
    public const int THINGCOLOR14 = ThingColor00Index + 14;
    public const int THINGCOLOR15 = ThingColor00Index + 15;
    public const int THINGCOLOR16 = ThingColor00Index + 16;
    public const int THINGCOLOR17 = ThingColor00Index + 17;
    public const int THINGCOLOR18 = ThingColor00Index + 18;
    public const int THINGCOLOR19 = ThingColor00Index + 19;
    public const int THREEDFLOORCOLOR = ThreeDFloorColorIndex;
    public const int SCRIPTINDICATOR = ScriptIndicatorIndex;
    public const int SCRIPTBRACEHIGHLIGHT = ScriptBraceHighlightIndex;
    public const int SCRIPTBADBRACEHIGHLIGHT = ScriptBadBraceHighlightIndex;
    public const int SCRIPTWHITESPACE = ScriptWhitespaceIndex;
    public const int SCRIPTSELECTIONFORE = ScriptSelectionForeIndex;
    public const int SCRIPTSELECTIONBACK = ScriptSelectionBackIndex;
    public const int STRINGS = StringsIndex;
    public const int INCLUDES = IncludesIndex;
    public const int SCRIPTFOLDFORE = ScriptFoldForeIndex;
    public const int SCRIPTFOLDBACK = ScriptFoldBackIndex;
    public const int PROPERTIES = PropertiesIndex;
    public const int GUIDELINECOLOR = GuidelineColorIndex;
