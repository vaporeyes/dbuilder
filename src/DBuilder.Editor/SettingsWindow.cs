...
public sealed class SettingsWindow : PropertyDialog
{
    ...
    public bool SelectChangedAfterUndoRedo;
    ...
    public SettingsWindow(Settings s) : base("Settings", "Leave a field blank to use the built-in default.")
    {
        ...
        _selectChangedAfterUndoRedo = AddCheckBox("Select changed elements after undo/redo", s.SelectChangedAfterUndoRedo);
    ...
    protected override void OnConfirm()
    {
        ...
        SelectChangedAfterUndoRedo = _selectChangedAfterUndoRedo.IsChecked == true;
