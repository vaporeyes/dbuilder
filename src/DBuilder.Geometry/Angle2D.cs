// ABOUTME: Angle constants and helpers ported from UDB Source/Core/Geometry/Angle2D.cs.
// ABOUTME: Behavior preserved 1:1; namespace changed to DBuilder.Geometry.
...
public struct Angle2D
{
    ...
    public static double DegToRad(double deg) => deg / PIDEG;

    // This converts radians to degrees
    public static double RadToDeg(double rad) => rad * PIDEG;
