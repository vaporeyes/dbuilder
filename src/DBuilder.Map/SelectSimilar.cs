...
public sealed class SectorSimilarityOptions
{
    ...
    public bool FloorTextureOffsets { get; init; } = true;
    public bool CeilingTextureOffsets { get; init; } = true;
    public bool FloorTextureScale { get; init; } = true;
    public bool CeilingTextureScale { get; init; } = true;
    public bool FloorTextureRotation { get; init; } = true;
    public bool CeilingTextureRotation { get; init; } = true;
    public bool FloorAlpha { get; init; } = true;
    public bool CeilingAlpha { get; init; } = true;
    public bool FloorPortalAlpha { get; init; } = true;
    public bool CeilingPortalAlpha { get; init; } = true;
    public bool Brightness { get; init; } = true;
    public bool FloorBrightness { get; init; } = true;
    public bool CeilingBrightness { get; init; } = true;
    public bool FloorRenderStyle { get; init; } = true;
    public bool CeilingRenderStyle { get; init; } = true;
    public bool FloorPortalRenderStyle { get; init; } = true;
    public bool CeilingPortalRenderStyle { get; init; } = true;
    ...
    public bool FloorTerrain { get; init; } = true;
    public bool CeilingTerrain { get; init; } = true;
    public bool LightColor { get; init; } = true;
    public bool FadeColor { get; init; } = true;
    public bool FloorColor { get; init; } = true;
    public bool CeilingColor { get; init; } = true;
    public bool TopWallColor { get; init; } = true;
    public bool BottomWallColor { get; init; } = true;
    public bool SpritesColor { get; init; } = true;
    public bool FloorGlow { get; init; } = true;
    public bool CeilingGlow { get; init; } = true;
    public bool FogDensity { get; init; } = true;
    public bool Desaturation { get; init; } = true;
    public bool DamageType { get; init; } = true;
    public bool DamageAmount { get; init; } = true;
    public bool DamageInterval { get; init; } = true;
    public bool DamageLeakiness { get; init; } = true;
    public bool SoundSequence { get; init; } = true;
...
public static class SelectSimilar
{
    ...
    public static bool PropertiesMatch(SectorSimilarityOptions options, Sector source, Sector target)
    {
        ...
        if (options.FloorTextureOffsets && !FieldValuesMatch(source.Fields, target.Fields, "xpanningfloor", "ypanningfloor")) return false;
        if (options.CeilingTextureOffsets && !FieldValuesMatch(source.Fields, target.Fields, "xpanningceiling", "ypanningceiling")) return false;
        if (options.FloorTextureScale && !FieldValuesMatch(source.Fields, target.Fields, "xscalefloor", "yscalefloor")) return false;
        if (options.CeilingTextureScale && !FieldValuesMatch(source.Fields, target.Fields, "xscaleceiling", "yscaleceiling")) return false;
        if (options.FloorTextureRotation && !FieldValueMatches(source.Fields, target.Fields, "rotationfloor")) return false;
        if (options.CeilingTextureRotation && !FieldValueMatches(source.Fields, target.Fields, "rotationceiling")) return false;
        if (options.FloorAlpha && !FieldValueMatches(source.Fields, target.Fields, "alphafloor")) return false;
        if (options.CeilingAlpha && !FieldValueMatches(source.Fields, target.Fields, "alphaceiling")) return false;
        if (options.FloorPortalAlpha && !FieldValueMatches(source.Fields, target.Fields, "portal_floor_alpha")) return false;
        if (options.CeilingPortalAlpha && !FieldValueMatches(source.Fields, target.Fields, "portal_ceil_alpha")) return false;
        if (options.Brightness && source.Brightness != target.Brightness) return false;
        if (options.FloorBrightness && !FieldValuesMatch(source.Fields, target.Fields, "lightfloor", "lightfloorabsolute")) return false;
        if (options.CeilingBrightness && !FieldValuesMatch(source.Fields, target.Fields, "lightceiling", "lightceilingabsolute")) return false;
        if (options.FloorRenderStyle && !FieldValueMatches(source.Fields, target.Fields, "renderstylefloor")) return false;
        if (options.CeilingRenderStyle && !FieldValueMatches(source.Fields, target.Fields, "renderstyleceiling")) return false;
        if (options.FloorPortalRenderStyle && !FieldValueMatches(source.Fields, target.Fields, "portal_floor_overlaytype")) return false;
        if (options.CeilingPortalRenderStyle && !FieldValueMatches(source.Fields, target.Fields, "portal_ceil_overlaytype")) return false;
        ...
        if (options.FloorTerrain && !FieldValueMatches(source.Fields, target.Fields, "floorterrain")) return false;
        if (options.CeilingTerrain && !FieldValueMatches(source.Fields, target.Fields, "ceilingterrain")) return false;
        if (options.LightColor && !FieldValueMatches(source.Fields, target.Fields, "lightcolor")) return false;
        if (options.FadeColor && !FieldValueMatches(source.Fields, target.Fields, "fadecolor")) return false;
        if (options.FloorColor && !FieldValueMatches(source.Fields, target.Fields, "color_floor")) return false;
        if (options.CeilingColor && !FieldValueMatches(source.Fields, target.Fields, "color_ceiling")) return false;
        if (options.TopWallColor && !FieldValueMatches(source.Fields, target.Fields, "color_walltop")) return false;
        if (options.BottomWallColor && !FieldValueMatches(source.Fields, target.Fields, "color_wallbottom")) return false;
        if (options.SpritesColor && !FieldValueMatches(source.Fields, target.Fields, "color_sprites")) return false;
        if (options.FloorGlow && !FieldValuesMatch(source.Fields, target.Fields, "floorglowcolor", "floorglowheight")) return false;
        if (options.CeilingGlow && !FieldValuesMatch(source.Fields, target.Fields, "ceilingglowcolor", "ceilingglowheight")) return false;
        if (options.FogDensity && !FieldValueMatches(source.Fields, target.Fields, "fogdensity")) return false;
        if (options.Desaturation && !FieldValueMatches(source.Fields, target.Fields, "desaturation")) return false;
        if (options.DamageType && !FieldValueMatches(source.Fields, target.Fields, "damagetype")) return false;
        if (options.DamageAmount && !FieldValueMatches(source.Fields, target.Fields, "damageamount")) return false;
        if (options.DamageInterval && !FieldValueMatches(source.Fields, target.Fields, "damageinterval")) return false;
        if (options.DamageLeakiness && !FieldValueMatches(source.Fields, target.Fields, "leakiness")) return false;
        if (options.SoundSequence && !FieldValueMatches(source.Fields, target.Fields, "soundsequence")) return false;
