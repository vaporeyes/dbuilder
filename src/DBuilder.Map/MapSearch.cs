...
public static class MapSearch
{
    ...
    [
        ...
        new(FindCategory.Texture, "Sidedef Texture (Any)"),
        new(FindCategory.SidedefUpperTexture, "Sidedef Texture (Upper)"),
        new(FindCategory.SidedefMiddleTexture, "Sidedef Texture (Middle)"),
        new(FindCategory.SidedefLowerTexture, "Sidedef Texture (Lower)"),
        new(FindCategory.Flat, "Sector Flat (Any)"),
        new(FindCategory.SectorFloorFlat, "Sector Flat (Floor)"),
        new(FindCategory.SectorCeilingFlat, "Sector Flat (Ceiling)"),
