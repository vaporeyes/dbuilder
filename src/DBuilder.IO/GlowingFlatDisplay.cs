...
public static class GlowingFlatDisplay
{
        ...
        bool classicRendering = false)
    {
        ...
        int color = lighting.Color == NoColorOverride ? VisualSurfaceLighting.NoColorOverride : lighting.Color;

        return VisualSurfaceLighting.RenderTint(brightness, color, scale, classicRendering);
    }
