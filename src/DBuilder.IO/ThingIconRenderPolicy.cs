...
{
    public const double CompactMarkerScaleThreshold = 0.08;
    ...
    public const double OverviewMarkerScaleThreshold = 0.16;
    public const double FarOverviewMarkerScaleThreshold = 0.28;
