...
internal interface IResourceReader : IDisposable
{
    ...
    /// <summary>ANIMDEFS texts selected with UDB's per-resource rules.</summary>
    IEnumerable<string> GetAnimdefsLumps();
    /// <summary>SNDSEQ texts selected with UDB's per-resource rules.</summary>
...
internal sealed class WadResourceReader : IResourceReader
{
    ...
    public IEnumerable<string> GetAnimdefsLumps() => GetTextLumps("ANIMDEFS", partialTitleMatch: false);

    public IEnumerable<string> GetSndSeqLumps() => GetTextLumps("SNDSEQ", partialTitleMatch: false);
...
internal abstract class FolderResourceReader : IResourceReader
{
    ...
    public virtual IEnumerable<string> GetDehackedLumps()
    {
        foreach (string text in LocalTextLumps("DEHACKED", partialTitleMatch: true))
            yield return text;
    ...
    public virtual IEnumerable<string> GetLockdefsLumps()
    {
        foreach (string text in LocalTextLumps("LOCKDEFS", partialTitleMatch: false))
            yield return text;
    ...
    public virtual IEnumerable<string> GetTerrainLumps()
    {
        foreach (string text in LocalTextLumps("TERRAIN", partialTitleMatch: false))
            yield return text;
    ...
    public virtual IEnumerable<string> GetAnimdefsLumps()
    {
        foreach (string text in LocalTextLumps("ANIMDEFS", partialTitleMatch: false))
            yield return text;
    ...
    public virtual IEnumerable<string> GetSndSeqLumps()
    {
        foreach (string text in LocalTextLumps("SNDSEQ", partialTitleMatch: false))
            yield return text;
    ...
    public virtual IEnumerable<string> GetReverbsLumps()
    {
        foreach (string text in LocalTextLumps("REVERBS", partialTitleMatch: false))
            yield return text;
