...
public static class EditorCommandCatalog
{
    public static IReadOnlyList<EditorCommandDescriptor> All { get; } = new[]
    {
        ...
        new EditorCommandDescriptor("map2d.selectsinglesided", "Select Single-sided", "Shift+Q", EditorCommandScope.Map2D, AllowScroll: true),
        new EditorCommandDescriptor("map2d.select-double-sided", "Select Double-sided", "Menu", EditorCommandScope.Map2D, AllowScroll: true),
        new EditorCommandDescriptor("map2d.selectdoublesided", "Select Double-sided", "Shift+R", EditorCommandScope.Map2D, AllowScroll: true),
        ...
        new EditorCommandDescriptor("map2d.lowerfloor8", "Lower Floor by 8 mp", "Ctrl/Cmd+Alt+ScrollDown", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true),
        ...
        new EditorCommandDescriptor("map2d.raisefloor8", "Raise Floor by 8 mp", "Ctrl/Cmd+Alt+ScrollUp", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true),
        ...
        new EditorCommandDescriptor("map2d.lowerceiling8", "Lower Ceiling by 8 mp", "Alt+Shift+ScrollDown", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true),
        ...
        new EditorCommandDescriptor("map2d.raiseceiling8", "Raise Ceiling by 8 mp", "Alt+Shift+ScrollUp", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true),
        ...
        new EditorCommandDescriptor("map3d.floodfilltextures", "Paste Texture Flood-Fill", "Shift+MButton", EditorCommandScope.Map3D, AllowScroll: true),
        ...
        new EditorCommandDescriptor("map3d.visual-auto-align", "Auto-align Textures X and Y", "Ctrl/Cmd+A", EditorCommandScope.Map3D, AllowScroll: true),
        new EditorCommandDescriptor("map3d.visualautoalign", "Auto-align Textures X and Y", "Ctrl/Cmd+A", EditorCommandScope.Map3D, AllowScroll: true),
        ...
        new EditorCommandDescriptor("map3d.visualfittextures", "Fit Textures", "Ctrl/Cmd+Alt+A", EditorCommandScope.Map3D, AllowScroll: true),
