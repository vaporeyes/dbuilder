...
public static class EditorCommandCatalog
{
    public static IReadOnlyList<EditorCommandDescriptor> All { get; } = new[]
    {
        ...
        new EditorCommandDescriptor("window.select-similar", "Select Similar Map Elements", "Menu", EditorCommandScope.Window, Description: "Selects map elements, similar to currently selected ones, based on a set of settings."),
        new EditorCommandDescriptor("window.selectsimilar", "Select Similar Map Elements", "Menu", EditorCommandScope.Window, Description: "Selects map elements, similar to currently selected ones, based on a set of settings."),
