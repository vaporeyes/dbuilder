...
public static class EditorCommandCatalog
{
    public static IReadOnlyList<EditorCommandDescriptor> All { get; } = new[]
    {
        ...
        new EditorCommandDescriptor("map2d.align-grid-to-linedef", "Align Grid to Selected Linedef", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Rotates and repositions the grid so that the selected linedef is along the X-axis."),
        new EditorCommandDescriptor("map2d.aligngridtolinedef", "Align Grid to Selected Linedef", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Rotates and repositions the grid so that the selected linedef is along the X-axis."),
