...
public static class EditorCommandCatalog
{
    public static IReadOnlyList<EditorCommandDescriptor> All { get; } = new[]
    {
        ...
        new EditorCommandDescriptor("map3d.flood-fill-texture", "Paste Texture Flood-Fill", "Ctrl/Cmd+V", EditorCommandScope.Map3D, AllowScroll: true),
    ...
    public static IReadOnlyList<EditorShortcutBinding> DefaultShortcuts { get; } = new[]
    {
        ...
        new EditorShortcutBinding("map3d.flood-fill-texture", EditorCommandScope.Map3D, "V", Accelerator: true),
