...
public static class EditorCommandCatalog
{
    public static IReadOnlyList<EditorCommandDescriptor> All { get; } = new[]
    {
        ...
        new EditorCommandDescriptor("window.toggle-info-panel", "Toggle Info Panel", "Menu", EditorCommandScope.Window, Description: "Toggles the info panel between expanded and collapsed."),
        new EditorCommandDescriptor("window.toggleinfopanel", "Toggle Info Panel", "Menu", EditorCommandScope.Window, Description: "Toggles the info panel between expanded and collapsed."),
        ...
        new EditorCommandDescriptor("window.copy-properties", "Copy Properties", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Copies the targeted object properties for pasting."),
        new EditorCommandDescriptor("window.classiccopyproperties", "Copy Properties", "Ctrl/Cmd+Shift+C", EditorCommandScope.Window, AllowScroll: true, Description: "Copies the properties of the highlighted or selected object for pasting."),
        new EditorCommandDescriptor("window.paste-properties", "Paste Properties", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Pastes the copied properties onto the targeted or selected object."),
        new EditorCommandDescriptor("window.classicpasteproperties", "Paste Properties", "Ctrl/Cmd+Alt+V", EditorCommandScope.Window, AllowScroll: true, Description: "Pastes the copied properties onto the highlighted or selected objects."),
        new EditorCommandDescriptor("window.paste-properties-options", "Paste Properties With Options", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Pastes the copied properties onto the highlighted or selected objects allowing you to choose the properties to paste."),
        ...
        new EditorCommandDescriptor("window.select-similar", "Select Similar Map Elements", "Menu", EditorCommandScope.Window, AllowMouse: false, Description: "Selects map elements, similar to currently selected ones, based on a set of settings."),
        new EditorCommandDescriptor("window.selectsimilar", "Select Similar Map Elements", "Menu", EditorCommandScope.Window, AllowMouse: false, Description: "Selects map elements, similar to currently selected ones, based on a set of settings."),
        new EditorCommandDescriptor("window.filter-selected-things", "Filter Selected Things", "Menu", EditorCommandScope.Window, AllowMouse: false, Description: "Opens a window, which lets you pick thing type(s) you want to leave selected."),
        new EditorCommandDescriptor("window.filterselectedthings", "Filter Selected Things", "Menu", EditorCommandScope.Window, AllowMouse: false, Description: "Opens a window, which lets you pick thing type(s) you want to leave selected."),
        new EditorCommandDescriptor("window.change-map-element-index", "Change Map Element Index", "Menu", EditorCommandScope.Window, Description: "Changes the index of the highlighted or selected vertex, linedef, sector, or thing. Only works on a single map element. It will shift all indices between the old and new index."),
        new EditorCommandDescriptor("window.changemapelementindex", "Change Map Element Index", "Menu", EditorCommandScope.Window, Description: "Changes the index of the highlighted or selected vertex, linedef, sector, or thing. Only works on a single map element. It will shift all indices between the old and new index."),
        new EditorCommandDescriptor("window.stitch-geometry", "Stitch geometry", "Menu", EditorCommandScope.Window),
        new EditorCommandDescriptor("window.geomergeclassic", "Merge Dragged Vertices Only", "Menu", EditorCommandScope.Window, Description: "Only vertex-line intersections will be processed when applying geometry drag or paste actions."),
        new EditorCommandDescriptor("window.geomerge", "Merge Dragged Geometry", "Menu", EditorCommandScope.Window, Description: "Geometry merging will be performed when applying geometry drag or paste actions."),
        new EditorCommandDescriptor("window.georeplace", "Replace with Dragged Geometry", "Menu", EditorCommandScope.Window, Description: "Dragged geometry will replace underlaying geometry when applying geometry drag or paste actions."),
        new EditorCommandDescriptor("window.join-sectors", "Join Sectors", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Joins two or more selected sectors together and keeps all linedefs."),
        new EditorCommandDescriptor("window.merge-sectors", "Merge Sectors", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Joins two or more selected sectors together and removes the shared linedefs."),
        ...
        new EditorCommandDescriptor("window.moveselectionup", "Move Selection Up by Grid Size", "Menu", EditorCommandScope.Window, AllowScroll: true, Repeat: true, Description: "Moves the selection in Edit Selection mode up by the current grid size."),
        new EditorCommandDescriptor("window.moveselectiondown", "Move Selection Down by Grid Size", "Menu", EditorCommandScope.Window, AllowScroll: true, Repeat: true, Description: "Moves the selection in Edit Selection mode down by the current grid size."),
        new EditorCommandDescriptor("window.moveselectionleft", "Move Selection Left by Grid Size", "Menu", EditorCommandScope.Window, AllowScroll: true, Repeat: true, Description: "Moves the selection in Edit Selection mode left by the current grid size."),
        new EditorCommandDescriptor("window.moveselectionright", "Move Selection Right by Grid Size", "Menu", EditorCommandScope.Window, AllowScroll: true, Repeat: true, Description: "Moves the selection in Edit Selection mode right by the current grid size."),
        ...
        new EditorCommandDescriptor("window.make-door", "Make Door", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Creates doors from the highlighted or selected sectors."),
        new EditorCommandDescriptor("window.makedoor", "Make Door", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Creates doors from the highlighted or selected sectors."),
        new EditorCommandDescriptor("window.build-stairs", "Build Stairs", "Menu", EditorCommandScope.Window, AllowScroll: true),
        new EditorCommandDescriptor("window.tag-range", "Tag Range", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Allows giving a range of tags to a selection of sectors, linedefs or things."),
        new EditorCommandDescriptor("window.rangetagselection", "Tag Range", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Allows giving a range of tags to a selection of sectors, linedefs or things."),
        new EditorCommandDescriptor("window.blockmap-explorer", "Blockmap Explorer mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Displays the map's BLOCKMAP information"),
        new EditorCommandDescriptor("window.blockmapexplorermode", "Blockmap Explorer mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Displays the map's BLOCKMAP information"),
        new EditorCommandDescriptor("window.reject-explorer", "Reject Explorer mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Displays the map's REJECT information"),
        new EditorCommandDescriptor("window.rejectexplorermode", "Reject Explorer mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Displays the map's REJECT information"),
        new EditorCommandDescriptor("window.rejectexplorercolorconfiguration", "Configure colors", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Configure colors for reject explorer mode"),
        new EditorCommandDescriptor("window.nodes-viewer", "Nodes Viewer Mode", "Menu", EditorCommandScope.Window, Description: "Switches to the Nodes Viewer mode."),
        new EditorCommandDescriptor("window.nodesviewermode", "Nodes Viewer Mode", "Menu", EditorCommandScope.Window, Description: "Switches to the Nodes Viewer mode."),
        new EditorCommandDescriptor("window.sound-propagation-mode", "Sound propagation mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Shows how sound propagates through the map"),
        new EditorCommandDescriptor("window.soundpropagationmode", "Sound propagation mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Shows how sound propagates through the map"),
        new EditorCommandDescriptor("window.sound-environment-mode", "Sound environment mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Shows ZDoom sound environments"),
        new EditorCommandDescriptor("window.soundenvironmentmode", "Sound environment mode", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Shows ZDoom sound environments"),
        new EditorCommandDescriptor("window.sound-propagation-colors", "Configure colors", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Configure colors for sound propagation mode"),
        new EditorCommandDescriptor("window.soundpropagationcolorconfiguration", "Configure colors", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Configure colors for sound propagation mode"),
        new EditorCommandDescriptor("window.setleakfinderstart", "Set leak finder start sector", "Shift+S", EditorCommandScope.Window, AllowScroll: true, Description: "Sets the starting sector for the sound leak finder"),
        new EditorCommandDescriptor("window.setleakfinderend", "Set leak finder end sector", "Shift+E", EditorCommandScope.Window, AllowScroll: true, Description: "Sets the ending sector for the sound leak finder"),
        new EditorCommandDescriptor("window.applyjitter", "Randomize", "Ctrl/Cmd+J", EditorCommandScope.Window, AllowMouse: false, AllowScroll: false, Description: "Allows to apply a variety of randomized transformations to the selection."),
        new EditorCommandDescriptor("window.applydirectionalshading", "Apply Directional Shading", "Ctrl/Cmd+L", EditorCommandScope.Window, AllowMouse: false, AllowScroll: false, Description: "Allows to apply directional colored flat shading to the selection."),
        ...
        new EditorCommandDescriptor("window.grid-setup", "Grid and Backdrop Setup", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Shows the Custom Grid Setup dialog which allows you to set custom grid sizes and a background image."),
        new EditorCommandDescriptor("window.gridsetup", "Grid and Backdrop Setup", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Shows the Custom Grid Setup dialog which allows you to set custom grid sizes and a background image."),
        new EditorCommandDescriptor("window.usdf-conversations", "USDF Conversations", "Menu", EditorCommandScope.Window, AllowScroll: true),
        new EditorCommandDescriptor("window.usdf-dialog-editor", "Dialog Editor", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "This opens the dialog editor that allows you to edit DIALOGUE conversations in your map."),
        new EditorCommandDescriptor("window.opendialogeditor", "Dialog Editor", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "This opens the dialog editor that allows you to edit DIALOGUE conversations in your map."),
        ...
        new EditorCommandDescriptor("window.align-things-to-wall", "Align Things to Wall", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Aligns selected things to the nearest linedef."),
        new EditorCommandDescriptor("window.find-replace", "Find and Replace", "Menu", EditorCommandScope.Window, AllowScroll: true, Description: "Finds vertices, linedefs, sectors or things with a specific property, selects them and optionally replaces them with a given setting."),
        ...
        new EditorCommandDescriptor("window.select-group-1", "Select Group 1", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 1"),
        new EditorCommandDescriptor("window.select-group-2", "Select Group 2", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 2"),
        new EditorCommandDescriptor("window.select-group-3", "Select Group 3", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 3"),
        new EditorCommandDescriptor("window.select-group-4", "Select Group 4", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 4"),
        new EditorCommandDescriptor("window.select-group-5", "Select Group 5", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 5"),
        new EditorCommandDescriptor("window.select-group-6", "Select Group 6", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 6"),
        new EditorCommandDescriptor("window.select-group-7", "Select Group 7", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 7"),
        new EditorCommandDescriptor("window.select-group-8", "Select Group 8", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 8"),
        new EditorCommandDescriptor("window.select-group-9", "Select Group 9", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 9"),
        new EditorCommandDescriptor("window.select-group-10", "Select Group 10", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 10"),
        new EditorCommandDescriptor("window.selectgroup1", "Select Group 1", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 1"),
        new EditorCommandDescriptor("window.selectgroup2", "Select Group 2", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 2"),
        new EditorCommandDescriptor("window.selectgroup3", "Select Group 3", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 3"),
        new EditorCommandDescriptor("window.selectgroup4", "Select Group 4", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 4"),
        new EditorCommandDescriptor("window.selectgroup5", "Select Group 5", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 5"),
        new EditorCommandDescriptor("window.selectgroup6", "Select Group 6", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 6"),
        new EditorCommandDescriptor("window.selectgroup7", "Select Group 7", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 7"),
        new EditorCommandDescriptor("window.selectgroup8", "Select Group 8", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 8"),
        new EditorCommandDescriptor("window.selectgroup9", "Select Group 9", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 9"),
        new EditorCommandDescriptor("window.selectgroup10", "Select Group 10", "Menu", EditorCommandScope.Window, Description: "Selects all geometry that was assigned to group 10"),
        new EditorCommandDescriptor("window.assign-group-1", "Assign Group 1", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 1"),
        new EditorCommandDescriptor("window.assign-group-2", "Assign Group 2", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 2"),
        new EditorCommandDescriptor("window.assign-group-3", "Assign Group 3", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 3"),
        new EditorCommandDescriptor("window.assign-group-4", "Assign Group 4", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 4"),
        new EditorCommandDescriptor("window.assign-group-5", "Assign Group 5", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 5"),
        new EditorCommandDescriptor("window.assign-group-6", "Assign Group 6", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 6"),
        new EditorCommandDescriptor("window.assign-group-7", "Assign Group 7", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 7"),
        new EditorCommandDescriptor("window.assign-group-8", "Assign Group 8", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 8"),
        new EditorCommandDescriptor("window.assign-group-9", "Assign Group 9", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 9"),
        new EditorCommandDescriptor("window.assign-group-10", "Assign Group 10", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 10"),
        new EditorCommandDescriptor("window.assigngroup1", "Assign Group 1", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 1"),
        new EditorCommandDescriptor("window.assigngroup2", "Assign Group 2", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 2"),
        new EditorCommandDescriptor("window.assigngroup3", "Assign Group 3", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 3"),
        new EditorCommandDescriptor("window.assigngroup4", "Assign Group 4", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 4"),
        new EditorCommandDescriptor("window.assigngroup5", "Assign Group 5", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 5"),
        new EditorCommandDescriptor("window.assigngroup6", "Assign Group 6", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 6"),
        new EditorCommandDescriptor("window.assigngroup7", "Assign Group 7", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 7"),
        new EditorCommandDescriptor("window.assigngroup8", "Assign Group 8", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 8"),
        new EditorCommandDescriptor("window.assigngroup9", "Assign Group 9", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 9"),
        new EditorCommandDescriptor("window.assigngroup10", "Assign Group 10", "Menu", EditorCommandScope.Window, Description: "Assigns the selected geometry to group 10"),
        new EditorCommandDescriptor("window.clear-group-1", "Clear Group 1", "Ctrl/Cmd+Shift+1", EditorCommandScope.Window, Description: "Clears group 1"),
        new EditorCommandDescriptor("window.clear-group-2", "Clear Group 2", "Ctrl/Cmd+Shift+2", EditorCommandScope.Window, Description: "Clears group 2"),
        new EditorCommandDescriptor("window.clear-group-3", "Clear Group 3", "Ctrl/Cmd+Shift+3", EditorCommandScope.Window, Description: "Clears group 3"),
        new EditorCommandDescriptor("window.clear-group-4", "Clear Group 4", "Ctrl/Cmd+Shift+4", EditorCommandScope.Window, Description: "Clears group 4"),
        new EditorCommandDescriptor("window.clear-group-5", "Clear Group 5", "Ctrl/Cmd+Shift+5", EditorCommandScope.Window, Description: "Clears group 5"),
        new EditorCommandDescriptor("window.clear-group-6", "Clear Group 6", "Ctrl/Cmd+Shift+6", EditorCommandScope.Window, Description: "Clears group 6"),
        new EditorCommandDescriptor("window.clear-group-7", "Clear Group 7", "Ctrl/Cmd+Shift+7", EditorCommandScope.Window, Description: "Clears group 7"),
        new EditorCommandDescriptor("window.clear-group-8", "Clear Group 8", "Ctrl/Cmd+Shift+8", EditorCommandScope.Window, Description: "Clears group 8"),
        new EditorCommandDescriptor("window.clear-group-9", "Clear Group 9", "Ctrl/Cmd+Shift+9", EditorCommandScope.Window, Description: "Clears group 9"),
        new EditorCommandDescriptor("window.clear-group-10", "Clear Group 10", "Ctrl/Cmd+Shift+0", EditorCommandScope.Window, Description: "Clears group 10"),
        new EditorCommandDescriptor("window.cleargroup1", "Clear Group 1", "Ctrl/Cmd+Shift+1", EditorCommandScope.Window, Description: "Clears group 1"),
        new EditorCommandDescriptor("window.cleargroup2", "Clear Group 2", "Ctrl/Cmd+Shift+2", EditorCommandScope.Window, Description: "Clears group 2"),
        new EditorCommandDescriptor("window.cleargroup3", "Clear Group 3", "Ctrl/Cmd+Shift+3", EditorCommandScope.Window, Description: "Clears group 3"),
        new EditorCommandDescriptor("window.cleargroup4", "Clear Group 4", "Ctrl/Cmd+Shift+4", EditorCommandScope.Window, Description: "Clears group 4"),
        new EditorCommandDescriptor("window.cleargroup5", "Clear Group 5", "Ctrl/Cmd+Shift+5", EditorCommandScope.Window, Description: "Clears group 5"),
        new EditorCommandDescriptor("window.cleargroup6", "Clear Group 6", "Ctrl/Cmd+Shift+6", EditorCommandScope.Window, Description: "Clears group 6"),
        new EditorCommandDescriptor("window.cleargroup7", "Clear Group 7", "Ctrl/Cmd+Shift+7", EditorCommandScope.Window, Description: "Clears group 7"),
        new EditorCommandDescriptor("window.cleargroup8", "Clear Group 8", "Ctrl/Cmd+Shift+8", EditorCommandScope.Window, Description: "Clears group 8"),
        new EditorCommandDescriptor("window.cleargroup9", "Clear Group 9", "Ctrl/Cmd+Shift+9", EditorCommandScope.Window, Description: "Clears group 9"),
        new EditorCommandDescriptor("window.cleargroup10", "Clear Group 10", "Ctrl/Cmd+Shift+0", EditorCommandScope.Window, Description: "Clears group 10"),
        ...
        new EditorCommandDescriptor("map2d.edit-properties", "Edit properties", "Double-click", EditorCommandScope.Map2D, Description: "Edits the properties of the selected items or drags the selected items. Also initiates drawing or inserts new things when no selection is made. Can be used in combination with Control and Shift for the first drawn vertex."),
        ...
        new EditorCommandDescriptor("map2d.split-line", "Split Linedefs", "Right-click", EditorCommandScope.Map2D, AllowScroll: true, Description: "Splits the selected linedefs in the middle, or splits the highlighted linedef at the mouse position."),
        ...
        new EditorCommandDescriptor("map2d.scrollwest", "Scroll West", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true, Description: "Scrolls the 2D map view to the left."),
        new EditorCommandDescriptor("map2d.scrolleast", "Scroll East", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true, Description: "Scrolls the 2D map view to the right."),
        new EditorCommandDescriptor("map2d.scrollnorth", "Scroll North", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true, Description: "Scrolls the 2D map view up."),
        new EditorCommandDescriptor("map2d.scrollsouth", "Scroll South", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Repeat: true, Description: "Scrolls the 2D map view down."),
        ...
        new EditorCommandDescriptor("map2d.mode-vertices", "Vertices mode", "1", EditorCommandScope.Map2D, Description: "Switches to vertices editing mode."),
        new EditorCommandDescriptor("map2d.verticesmode", "Vertices Mode", "V", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to vertices editing mode."),
        new EditorCommandDescriptor("map2d.mode-linedefs", "Linedefs mode", "2", EditorCommandScope.Map2D, Description: "Switches to linedefs editing mode."),
        new EditorCommandDescriptor("map2d.linedefsmode", "Linedefs Mode", "L", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to linedefs editing mode."),
        new EditorCommandDescriptor("map2d.mode-sectors", "Sectors mode", "3", EditorCommandScope.Map2D, Description: "Switches to sectors editing mode."),
        new EditorCommandDescriptor("map2d.sectorsmode", "Sectors Mode", "S", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to sectors editing mode."),
        new EditorCommandDescriptor("map2d.mode-things", "Things mode", "4", EditorCommandScope.Map2D, Description: "Switches to things editing mode."),
        new EditorCommandDescriptor("map2d.thingsmode", "Things Mode", "T", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to things editing mode."),
        new EditorCommandDescriptor("map2d.mode-image-example", "Image Example", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the image example mode."),
        new EditorCommandDescriptor("map2d.imageexamplemode", "Image Example", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the image example mode."),
        new EditorCommandDescriptor("map2d.mode-automap", "Automap Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Displays the map as shown in Doom's automap"),
        new EditorCommandDescriptor("map2d.automapmode", "Automap mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Displays the map as shown in Doom's automap"),
        ...
        new EditorCommandDescriptor("map2d.mode-wadauthor", "WadAuthor Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to WadAuthor editing mode."),
        new EditorCommandDescriptor("map2d.wadauthormode", "WadAuthor Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to WadAuthor editing mode."),
        new EditorCommandDescriptor("map2d.mode-visplane-explorer", "Visplane Explorer Mode", "Menu", EditorCommandScope.Map2D, Description: "Switches to the Visplane Explorer viewing mode."),
        new EditorCommandDescriptor("map2d.visplaneexplorermode", "Visplane Explorer Mode", "Menu", EditorCommandScope.Map2D, Description: "Switches to the Visplane Explorer viewing mode."),
        new EditorCommandDescriptor("map2d.mode-stair-sector-builder", "Stair Sector Builder Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the stair sector builder mode."),
        new EditorCommandDescriptor("map2d.stairsectorbuildermode", "Stair Sector Builder Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the stair sector builder mode."),
        new EditorCommandDescriptor("map2d.select-sectors-outline", "Select Sectors Outline", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Selects the outline of all marked sectors, deselecting lines that are shared."),
        new EditorCommandDescriptor("map2d.selectsectorsoutline", "Select Sectors Outline", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Selects the outline of all marked sectors, deselecting lines that are shared."),
        new EditorCommandDescriptor("map2d.mode-3d-floor", "3D Floor Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Edits 3D floors"),
        new EditorCommandDescriptor("map2d.threedfloorhelpermode", "3D floor editing mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Edits 3D floors"),
        new EditorCommandDescriptor("map2d.mode-3d-slope", "Slope Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Edits slope vertex groups"),
        new EditorCommandDescriptor("map2d.threedslopemode", "Slope mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Edits slope vertex groups"),
        new EditorCommandDescriptor("map2d.mode-draw-slopes", "Draw Slopes Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Draws a slope vertex group"),
        new EditorCommandDescriptor("map2d.drawslopesmode", "Draw slope mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Draws a slope vertex group"),
        new EditorCommandDescriptor("map2d.bridge-mode", "Bridge Mode", "Ctrl/Cmd+B", EditorCommandScope.Map2D, AllowMouse: false, Description: "Select two lines or two series of lines, then activate this tool to draw a bezier path between them."),
        new EditorCommandDescriptor("map2d.bridgemode", "Bridge Mode", "Ctrl/Cmd+B", EditorCommandScope.Map2D, AllowMouse: false, Description: "Select two lines or two series of lines, then activate this tool to draw a bezier path between them."),
        new EditorCommandDescriptor("map2d.3dfloor.draw-slope-point", "Draw slope vertex", "LButton", EditorCommandScope.Map2D, AllowScroll: true, DisregardShift: true, DisregardAccelerator: true, Description: "Draws a slope vertex at the mousecursor position."),
        new EditorCommandDescriptor("map2d.drawslopepoint", "Draw slope vertex", "LButton", EditorCommandScope.Map2D, AllowScroll: true, DisregardShift: true, DisregardAccelerator: true, Description: "Draws a slope vertex at the mousecursor position."),
        new EditorCommandDescriptor("map2d.3dfloor.draw-floor-slope", "Draw Floor Slope", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "The drawn slope will be applied to the floor"),
        new EditorCommandDescriptor("map2d.drawfloorslope", "Draw Floor Slope", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "The drawn slope will be applied to the floor"),
        new EditorCommandDescriptor("map2d.3dfloor.draw-ceiling-slope", "Draw Ceiling Slope", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "The drawn slope will be applied to the ceiling"),
        new EditorCommandDescriptor("map2d.drawceilingslope", "Draw Ceiling Slope", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "The drawn slope will be applied to the ceiling"),
        new EditorCommandDescriptor("map2d.3dfloor.draw-floor-and-ceiling-slope", "Draw Floor and Ceiling Slope", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "The drawn slope will be applied to the floor and ceiling"),
        new EditorCommandDescriptor("map2d.drawfloorandceilingslope", "Draw Floor and Ceiling Slope", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "The drawn slope will be applied to the floor and ceiling"),
        new EditorCommandDescriptor("map2d.3dfloor.finish-slope-draw", "Finish Slope Drawing", "RButton", EditorCommandScope.Map2D, AllowScroll: true, Description: "Finishes the slope drawing."),
        new EditorCommandDescriptor("map2d.finishslopedraw", "Finish Slope Drawing", "RButton", EditorCommandScope.Map2D, AllowScroll: true, Description: "Finishes the slope drawing."),
        ...
        new EditorCommandDescriptor("map2d.3dfloor.cycle-highlight-up", "Cycle highlighted 3D floor up", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Cycles up through the 3D floors of the currently highlighted sector"),
        new EditorCommandDescriptor("map2d.cyclehighlighted3dfloorup", "Cycle highlighted 3D floor up", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Cycles up through the 3D floors of the currently highlighted sector"),
        new EditorCommandDescriptor("map2d.3dfloor.cycle-highlight-down", "Cycle highlighted 3D floor down", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Cycles down through the 3D floors of the currently highlighted sector"),
        new EditorCommandDescriptor("map2d.cyclehighlighted3dfloordown", "Cycle highlighted 3D floor down", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Cycles down through the 3D floors of the currently highlighted sector"),
        new EditorCommandDescriptor("map2d.3dfloor.relocate-control-sectors", "Relocate 3D floor control sectors", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Relocates the managed 3D floor control sectors to the current position of the control sector area"),
        new EditorCommandDescriptor("map2d.relocate3dfloorcontrolsectors", "Relocate 3D floor control sectors", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Relocates the managed 3D floor control sectors to the current position of the control sector area"),
        new EditorCommandDescriptor("map2d.3dfloor.select-control-sector", "Select 3D floor control sector", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Selects the control sector of the currently highlighted 3D floor. Removes all other selections"),
        new EditorCommandDescriptor("map2d.select3dfloorcontrolsector", "Select 3D floor control sector", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Selects the control sector of the currently highlighted 3D floor. Removes all other selections"),
        new EditorCommandDescriptor("map2d.3dfloor.duplicate-geometry", "Duplicate and paste geometry", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Duplicates and pastes selected geometry and its 3D floors"),
        new EditorCommandDescriptor("map2d.duplicate3dfloorgeometry", "Duplicate and paste geometry", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Duplicates and pastes selected geometry and its 3D floors"),
        ...
        new EditorCommandDescriptor("map2d.toggle-comments", "Toggle Comments", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "Toggles rendering of comment icons in Sectors, Things and Linedefs modes (UDMF only)."),
        new EditorCommandDescriptor("map2d.togglecomments", "Toggle Comments", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "Toggles rendering of comment icons in Sectors, Things and Linedefs modes (UDMF only)."),
        new EditorCommandDescriptor("map2d.toggle-fixed-things-scale", "Toggle Fixed Things Scale", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "When enabled, Things will no longer be scaled based on current zoom level in Classic modes."),
        new EditorCommandDescriptor("map2d.togglefixedthingsscale", "Toggle Fixed Things Scale", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "When enabled, Things will no longer be scaled based on current zoom level in Classic modes."),
        new EditorCommandDescriptor("map2d.toggle-always-show-vertices", "Toggle Always Show Vertices", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "When enabled, vertices will always be drawn, regardless of the current mode."),
        new EditorCommandDescriptor("map2d.togglealwaysshowvertices", "Toggle Always Show Vertices", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "When enabled, vertices will always be drawn, regardless of the current mode."),
        new EditorCommandDescriptor("map2d.toggle-full-brightness", "Toggle Full Brightness", "B", EditorCommandScope.Map2D, AllowScroll: true, Description: "Toggles the use of sector brightness on and off. When sector brightness is off, the world is displayed fully bright, without lighting effects."),
        new EditorCommandDescriptor("map2d.toggle-highlight", "Toggle Highlight", "H", EditorCommandScope.Map2D, AllowScroll: true, Description: "Toggles the highlight of the targeted and selected objects."),
        new EditorCommandDescriptor("map2d.togglehighlight", "Toggle Highlight", "H", EditorCommandScope.Map2D, AllowScroll: true, Description: "Toggles the highlight of the targeted and selected objects."),
        new EditorCommandDescriptor("map2d.view-mode-wireframe", "View Wireframe", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Wireframe. This shows only the map elements without any sector filling."),
        new EditorCommandDescriptor("map2d.viewmodenormal", "View Wireframe", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Wireframe. This shows only the map elements without any sector filling."),
        new EditorCommandDescriptor("map2d.view-mode-brightness", "View Brightness Levels", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Brightness Levels. This fills all sectors with their brightness levels."),
        new EditorCommandDescriptor("map2d.viewmodebrightness", "View Brightness Levels", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Brightness Levels. This fills all sectors with their brightness levels."),
        new EditorCommandDescriptor("map2d.view-mode-floors", "View Floor Textures", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Floor Textures. In this view mode the sectors are filled with their floor texture and with their brightness level applied."),
        new EditorCommandDescriptor("map2d.viewmodefloors", "View Floor Textures", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Floor Textures. In this view mode the sectors are filled with their floor texture and with their brightness level applied."),
        new EditorCommandDescriptor("map2d.view-mode-ceilings", "View Ceiling Textures", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Ceiling Textures. In this view mode the sectors are filled with their ceiling texture and with their brightness level applied."),
        new EditorCommandDescriptor("map2d.viewmodeceilings", "View Ceiling Textures", "Menu", EditorCommandScope.Map2D, Description: "This sets the view mode to Ceiling Textures. In this view mode the sectors are filled with their ceiling texture and with their brightness level applied."),
        new EditorCommandDescriptor("map2d.flooralignmode", "Floor Align Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the (G)ZDoom Floor Align mode."),
        new EditorCommandDescriptor("map2d.ceilingalignmode", "Ceiling Align Mode", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the (G)ZDoom Ceiling Align mode."),
        new EditorCommandDescriptor("map2d.next-view-mode", "Next View Mode", "Menu", EditorCommandScope.Map2D, Description: "This switches to next view mode."),
        new EditorCommandDescriptor("map2d.nextviewmode", "Next View Mode", "Menu", EditorCommandScope.Map2D, Description: "This switches to next view mode."),
        ...
        new EditorCommandDescriptor("map2d.draw-point", "Draw Vertex", "Menu", EditorCommandScope.Map2D, AllowScroll: true, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Draws a vertex at the mousecursor position."),
        new EditorCommandDescriptor("map2d.drawpoint", "Draw Vertex", "Menu", EditorCommandScope.Map2D, AllowScroll: true, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Draws a vertex at the mousecursor position."),
        new EditorCommandDescriptor("map2d.remove-draw-point", "Remove Last Vertex", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Removes the last drawn vertex from the drawing session."),
        new EditorCommandDescriptor("map2d.removepoint", "Remove Last Vertex", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Removes the last drawn vertex from the drawing session."),
        new EditorCommandDescriptor("map2d.remove-first-draw-point", "Remove First Vertex", "Ctrl/Cmd+Backspace", EditorCommandScope.Map2D, AllowScroll: true, Description: "Removes the first drawn vertex from the drawing session."),
        new EditorCommandDescriptor("map2d.removefirstpoint", "Remove First Vertex", "Ctrl/Cmd+Backspace", EditorCommandScope.Map2D, AllowScroll: true, Description: "Removes the first drawn vertex from the drawing session."),
        new EditorCommandDescriptor("map2d.insert", "Insert vertex or thing", "I", EditorCommandScope.Map2D, Description: "Creates a new item depending on the editing mode you are in."),
        ...
        new EditorCommandDescriptor("map2d.placevisualstart", "Place Visual Mode Camera", "Ctrl/Cmd+W", EditorCommandScope.Map2D, AllowScroll: true, Description: "Places a new, or moves the existing, Visual Mode start thing to the mouse position. This thing will keep track where you left Visual Mode so that you return to Visual Mode in the same location."),
        new EditorCommandDescriptor("map2d.place-things", "Place Things", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "Creates things of given type and places them inside of selected sectors or on top of selected vertices."),
        new EditorCommandDescriptor("map2d.placethings", "Place Things", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "Creates things of given type and places them inside of selected sectors or on top of selected vertices."),
        new EditorCommandDescriptor("map2d.thingaligntowall", "Align Things to Nearest Linedef", "Ctrl/Cmd+Shift+A", EditorCommandScope.Map2D, AllowScroll: true, Description: "Aligns selected things to the nearest linedef."),
        new EditorCommandDescriptor("map2d.point-thing-to-cursor", "Point Thing to Cursor", "Shift+L", EditorCommandScope.Map2D, AllowScroll: true, DisregardAccelerator: true, Description: "Points selected things to cursor position. Hold Ctrl to point away from cursor."),
        new EditorCommandDescriptor("map2d.thinglookatcursor", "Point Thing to Cursor", "Shift+L", EditorCommandScope.Map2D, AllowScroll: true, DisregardAccelerator: true, Description: "Points selected things to cursor position. Hold Ctrl to point away from cursor."),
        new EditorCommandDescriptor("map2d.syncedthingedit", "Synchronized Things Editing", "Shift+T", EditorCommandScope.Map2D, Description: "When enabled, things selection/dragging will be synchronized to sector selection/dragging in Sectors mode. Selected things will be dragged when dragging linedefs in Linedefs mode. Deleting sectors will delete selected things in Sectors mode."),
        new EditorCommandDescriptor("map2d.make-sector", "Make sector at cursor", "M", EditorCommandScope.Map2D, AllowScroll: true, Description: "Switches to the Make Sector editing mode. This mode allows creating and/or fixing split sectors by clicking within a closed region."),
        ...
        new EditorCommandDescriptor("map2d.toggle-grid-rendering", "Toggle Grid", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "Toggles grid rendering in classic modes."),
        new EditorCommandDescriptor("map2d.togglegrid", "Toggle Grid", "Menu", EditorCommandScope.Map2D, AllowMouse: false, Description: "Toggles grid rendering in classic modes."),
        new EditorCommandDescriptor("map2d.toggle-dynamic-grid-size", "Toggle Dynamic Grid Size", "Ctrl/Cmd+Alt+G", EditorCommandScope.Map2D, AllowMouse: false, Description: "Toggles automatic grid size adjustment in classic modes."),
        new EditorCommandDescriptor("map2d.toggledynamicgrid", "Toggle Dynamic Grid Size", "Ctrl/Cmd+Alt+G", EditorCommandScope.Map2D, AllowMouse: false, Description: "Toggles automatic grid size adjustment in classic modes."),
        new EditorCommandDescriptor("map2d.align-grid-to-linedef", "Align Grid to Selected Linedef", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Realigns the grid so that the selected linedef is on a grid line."),
        new EditorCommandDescriptor("map2d.aligngridtolinedef", "Align Grid to Selected Linedef", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Realigns the grid so that the selected linedef is on a grid line."),
        new EditorCommandDescriptor("map2d.set-grid-origin-to-vertex", "Set Grid Origin to Selected Vertex", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Repositions the grid so that the selected vertex is at the origin."),
        new EditorCommandDescriptor("map2d.setgridorigintovertex", "Set Grid Origin to Selected Vertex", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Repositions the grid so that the selected vertex is at the origin."),
        new EditorCommandDescriptor("map2d.reset-grid-transform", "Reset Grid Transform", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Resets the grid to the default coordinate system."),
        new EditorCommandDescriptor("map2d.resetgrid", "Reset Grid Transform", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Resets the grid to the default coordinate system."),
        new EditorCommandDescriptor("map2d.smart-grid-transform", "Smart Grid Transform", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Sets grid transformation based on the selected elements. Vertex selected: set grid origin to that vertex. Linedef selected: align grid to that linedef. Nothing selected: reset grid transformation to the default coordinate system."),
        new EditorCommandDescriptor("map2d.smartgridtransform", "Smart Grid Transform", "Menu", EditorCommandScope.Map2D, AllowScroll: true, Description: "Sets grid transformation based on the selected elements. Vertex selected: set grid origin to that vertex. Linedef selected: align grid to that linedef. Nothing selected: reset grid transformation to the default coordinate system."),
        new EditorCommandDescriptor("map2d.grid-down", "Decrease grid size", "[", EditorCommandScope.Map2D, Repeat: true, Description: "Decreases the grid size, increasing the grid density."),
        new EditorCommandDescriptor("map2d.griddec", "Grid Increase", "]", EditorCommandScope.Map2D, AllowScroll: true, Description: "Increases the grid size, decreasing the grid density."),
        new EditorCommandDescriptor("map2d.grid-up", "Increase grid size", "]", EditorCommandScope.Map2D, Repeat: true, Description: "Increases the grid size, decreasing the grid density."),
        new EditorCommandDescriptor("map2d.gridinc", "Grid Decrease", "[", EditorCommandScope.Map2D, AllowScroll: true, Description: "Decreases the grid size, increasing the grid density."),
        ...
        new EditorCommandDescriptor("map3d.moveforward", "Move Forward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera forward in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.move-backward", "Move Backward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera backward in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.movebackward", "Move Backward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera backward in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.move-left", "Move Left (strafe)", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Strafes the camera left in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.moveleft", "Move Left (strafe)", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Strafes the camera left in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.move-right", "Move Right (strafe)", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Strafes the camera right in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.moveright", "Move Right (strafe)", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Strafes the camera right in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.orbit", "Orbit", "Menu", EditorCommandScope.Map3D, DisregardShift: true, Description: "When held, the mouse will orbit the camera around the point at the cursor, rather than look around."),
        new EditorCommandDescriptor("map3d.look", "Look around", "Arrows / drag", EditorCommandScope.Map3D),
        new EditorCommandDescriptor("map3d.move-up", "Move Up", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera up in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.moveup", "Move Up", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera up in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.move-down", "Move Down", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera down in 3D Visual Mode. Use in combination with Shift for double the speed."),
        new EditorCommandDescriptor("map3d.movedown", "Move Down", "Menu", EditorCommandScope.Map3D, AllowScroll: true, DisregardShift: true, Description: "Moves the camera down in 3D Visual Mode. Use in combination with Shift for double the speed."),
        ...
        new EditorCommandDescriptor("map3d.movethingleft", "Move Thing Left", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things left in Visual Modes."),
        new EditorCommandDescriptor("map3d.move-thing-right", "Move Thing Right", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things right in Visual Modes."),
        new EditorCommandDescriptor("map3d.movethingright", "Move Thing Right", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things right in Visual Modes."),
        new EditorCommandDescriptor("map3d.move-thing-forward", "Move Thing Forward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things away from camera in Visual Modes."),
        new EditorCommandDescriptor("map3d.movethingfwd", "Move Thing Forward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things away from camera in Visual Modes."),
        new EditorCommandDescriptor("map3d.move-thing-backward", "Move Thing Backward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things closer to camera in Visual Modes."),
        new EditorCommandDescriptor("map3d.movethingback", "Move Thing Backward", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Moves selected Things closer to camera in Visual Modes."),
        new EditorCommandDescriptor("map3d.insert-item", "Insert Item", "I / Insert", EditorCommandScope.Map3D, AllowScroll: true, Description: "Creates a new item depending on the editing mode you are in."),
        new EditorCommandDescriptor("map3d.insertitem", "Insert Item", "I / Insert", EditorCommandScope.Map3D, AllowScroll: true, Description: "Creates a new item depending on the editing mode you are in."),
        new EditorCommandDescriptor("map3d.copy-selection", "Copy Selection", "Ctrl/Cmd+C", EditorCommandScope.Map3D, Description: "Copies the current selection to the clipboard."),
        new EditorCommandDescriptor("map3d.copyselection", "Copy Selection", "Ctrl/Cmd+C", EditorCommandScope.Map3D, Description: "Copies the current selection to the clipboard."),
        new EditorCommandDescriptor("map3d.cut-selection", "Cut Selection", "Ctrl/Cmd+X", EditorCommandScope.Map3D, Description: "Copies the current selection to the clipboard and removes it from the map."),
        new EditorCommandDescriptor("map3d.cutselection", "Cut Selection", "Ctrl/Cmd+X", EditorCommandScope.Map3D, Description: "Copies the current selection to the clipboard and removes it from the map."),
        new EditorCommandDescriptor("map3d.paste-selection", "Paste Selection", "Ctrl/Cmd+V", EditorCommandScope.Map3D, Description: "Pastes the current contents of the clipboard into the map as a new selection."),
        new EditorCommandDescriptor("map3d.pasteselection", "Paste Selection", "Ctrl/Cmd+V", EditorCommandScope.Map3D, Description: "Pastes the current contents of the clipboard into the map as a new selection."),
        new EditorCommandDescriptor("map3d.place-thing-at-cursor", "Move Thing to Cursor Location", "Menu", EditorCommandScope.Map3D, AllowScroll: false, Description: "Moves selected Things to cursor location preserving relative offsets in Visual Modes."),
        new EditorCommandDescriptor("map3d.placethingatcursor", "Move Thing to Cursor Location", "Ctrl/Cmd+M", EditorCommandScope.Map3D, AllowScroll: false, Description: "Moves selected Things to cursor location preserving relative offsets in Visual Modes."),
        new EditorCommandDescriptor("map3d.rotate-clockwise", "Rotate Clockwise", "Ctrl/Cmd+Shift+ScrollUp", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things clockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotateclockwise", "Rotate Clockwise", "Ctrl/Cmd+Shift+ScrollUp", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things clockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotate-thing-clockwise", "Rotate Thing Clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things clockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotatethingclockwise", "Rotate Thing Clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things clockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotate-counterclockwise", "Rotate Counterclockwise", "Ctrl/Cmd+Shift+ScrollDown", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things counterclockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotatecounterclockwise", "Rotate Counterclockwise", "Ctrl/Cmd+Shift+ScrollDown", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things counterclockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotate-thing-counterclockwise", "Rotate Thing Counter-clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things counterclockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.rotatethingcounterclockwise", "Rotate Thing Counter-clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Rotates selected or highlighted things counterclockwise. Also rotates floor/ceiling textures in UDMF map format, and rotates the selection in Edit Selection mode."),
        new EditorCommandDescriptor("map3d.pitch-clockwise", "Change Pitch Clockwise", "Ctrl/Cmd+Alt+ScrollUp", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Increases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitchclockwise", "Change Pitch Clockwise", "Ctrl/Cmd+Alt+ScrollUp", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Increases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitch-thing-clockwise", "Pitch Thing Clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitchthingclockwise", "Pitch Thing Clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitch-counterclockwise", "Change Pitch Counterclockwise", "Ctrl/Cmd+Alt+ScrollDown", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Decreases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitchcounterclockwise", "Change Pitch Counterclockwise", "Ctrl/Cmd+Alt+ScrollDown", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Decreases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitch-thing-counterclockwise", "Pitch Thing Counter-clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.pitchthingcounterclockwise", "Pitch Thing Counter-clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases pitch of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.roll-clockwise", "Change Roll Clockwise", "Alt+ScrollUp", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Increases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.rollclockwise", "Change Roll Clockwise", "Alt+ScrollUp", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Increases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.roll-thing-clockwise", "Roll Thing Clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.rollthingclockwise", "Roll Thing Clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.roll-counterclockwise", "Change Roll Counterclockwise", "Alt+ScrollDown", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Decreases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.rollcounterclockwise", "Change Roll Counterclockwise", "Alt+ScrollDown", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Repeat: true, Description: "Decreases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.roll-thing-counterclockwise", "Roll Thing Counter-clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.rollthingcounterclockwise", "Roll Thing Counter-clockwise", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases roll of selected or highlighted things (UDMF only)."),
        new EditorCommandDescriptor("map3d.apply-camera-rotation", "Apply Camera Rotation To Things", "Menu", EditorCommandScope.Map3D, Description: "Applies the Visual Mode's current camera pitch and yaw to the selected things."),
        new EditorCommandDescriptor("map3d.apply-camera-rotation-to-things", "Apply Camera Rotation To Things", "Menu", EditorCommandScope.Map3D, Description: "Applies the Visual Mode's current camera pitch and yaw to the selected things."),
        new EditorCommandDescriptor("map3d.applycamerarotationtothings", "Apply Camera Rotation To Things", "Menu", EditorCommandScope.Map3D, Description: "Applies the Visual Mode's current camera pitch and yaw to the selected things."),
        new EditorCommandDescriptor("map3d.look-through-selection", "Look Through Selection", "Y", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Description: "Places visual camera at the same position as selected thing and rotates it to match thing's angle."),
        new EditorCommandDescriptor("map3d.look-through-thing", "Look Through Selection", "Y", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Description: "Places visual camera at the same position as selected thing and rotates it to match thing's angle."),
        new EditorCommandDescriptor("map3d.lookthroughthing", "Look Through Selection", "Y", EditorCommandScope.Map3D, AllowMouse: false, AllowScroll: true, Description: "Places visual camera at the same position as selected thing and rotates it to match thing's angle."),
        new EditorCommandDescriptor("map3d.thing-align-to-wall", "Align Things to Nearest Linedef", "Ctrl/Cmd+Shift+A", EditorCommandScope.Map3D, AllowScroll: true, Description: "Aligns selected things to the nearest linedef."),
        new EditorCommandDescriptor("map3d.align-things-to-wall", "Align Things to Nearest Linedef", "Ctrl/Cmd+Shift+A", EditorCommandScope.Map3D, AllowScroll: true, Description: "Aligns selected things to the nearest linedef."),
        new EditorCommandDescriptor("map3d.thingaligntowall", "Align Things to Nearest Linedef", "Ctrl/Cmd+Shift+A", EditorCommandScope.Map3D, AllowScroll: true, Description: "Aligns selected things to the nearest linedef."),
        new EditorCommandDescriptor("map3d.show-visual-things", "Show Things", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Cycles through the different ways the things are shown in Visual Mode."),
        new EditorCommandDescriptor("map3d.showvisualthings", "Show Things", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Cycles through the different ways the things are shown in Visual Mode."),
        new EditorCommandDescriptor("map3d.scale-up", "Increase Scale", "NumPad9", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases the scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scaleup", "Increase Scale", "NumPad9", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases the scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scale-down", "Decrease Scale", "NumPad7", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases the scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scaledown", "Decrease Scale", "NumPad7", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases the scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scale-up-x", "Increase Horizontal Scale", "NumPad6", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases horizontal scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scaleupx", "Increase Horizontal Scale", "NumPad6", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases horizontal scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scale-down-x", "Decrease Horizontal Scale", "NumPad4", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases horizontal scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scaledownx", "Decrease Horizontal Scale", "NumPad4", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases horizontal scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scale-up-y", "Increase Vertical Scale", "NumPad8", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases vertical scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scaleupy", "Increase Vertical Scale", "NumPad8", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases vertical scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scale-down-y", "Decrease Vertical Scale", "NumPad5", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases vertical scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        new EditorCommandDescriptor("map3d.scaledowny", "Decrease Vertical Scale", "NumPad5", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases vertical scale of targeted or selected textures or things by 0.1 (UDMF only)."),
        ...
        new EditorCommandDescriptor("map3d.lower-sector-1", "Lower Floor/Ceiling/Thing by 1 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by 1 mp. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.lowersector1", "Lower Floor/Ceiling/Thing by 1 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by 1 mp. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.raise-sector-1", "Raise Floor/Ceiling/Thing by 1 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by 1 mp. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.raisesector1", "Raise Floor/Ceiling/Thing by 1 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by 1 mp. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.lower-sector-8", "Lower Floor/Ceiling/Thing by 8 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by 8 mp. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.lowersector8", "Lower Floor/Ceiling/Thing by 8 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by 8 mp. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.raise-sector-8", "Raise Floor/Ceiling/Thing by 8 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by 8 mp. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.raisesector8", "Raise Floor/Ceiling/Thing by 8 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by 8 mp. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.lower-sector-128", "Lower Floor/Ceiling/Thing by 128 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by 128 mp. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.lowersector128", "Lower Floor/Ceiling/Thing by 128 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by 128 mp. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.raise-sector-128", "Raise Floor/Ceiling/Thing by 128 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by 128 mp. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.raisesector128", "Raise Floor/Ceiling/Thing by 128 mp", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by 128 mp. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.lower-map-element-by-grid-size", "Lower Floor/Ceiling/Thing by grid size", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by the current grid size. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.lowermapelementbygridsize", "Lower Floor/Ceiling/Thing by grid size", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Lowers the targeted or selected floors/ceilings by the current grid size. This also lowers selected or targeted things."),
        new EditorCommandDescriptor("map3d.raise-map-element-by-grid-size", "Raise Floor/Ceiling/Thing by grid size", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by the current grid size. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.raisemapelementbygridsize", "Raise Floor/Ceiling/Thing by grid size", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Raises the targeted or selected floors/ceilings by the current grid size. This also raises selected or targeted things."),
        new EditorCommandDescriptor("map3d.lower-sector-to-nearest", "Lower Floor/Ceiling/Thing to adjacent Sector/Thing", "PageDown", EditorCommandScope.Map3D, AllowScroll: true, DisregardAccelerator: true, Description: "Lowers the targeted or selected floors/ceilings to match the height of adjacent sector. Hold Ctrl to lower to lowest surface in selection. Also drops targeted or selected things to the nearest floor or ceiling or on top of another thing."),
        new EditorCommandDescriptor("map3d.lowersectortonearest", "Lower Floor/Ceiling/Thing to adjacent Sector/Thing", "PageDown", EditorCommandScope.Map3D, AllowScroll: true, DisregardAccelerator: true, Description: "Lowers the targeted or selected floors/ceilings to match the height of adjacent sector. Hold Ctrl to lower to lowest surface in selection. Also drops targeted or selected things to the nearest floor or ceiling or on top of another thing."),
        new EditorCommandDescriptor("map3d.raise-sector-to-nearest", "Raise Floor/Ceiling/Thing to adjacent Sector/Thing", "PageUp", EditorCommandScope.Map3D, AllowScroll: true, DisregardAccelerator: true, Description: "Raises the targeted or selected floors/ceilings to match the height of adjacent sector. Hold Ctrl to raise to highest surface in selection. Also raises targeted or selected things to the nearest ceiling or floor or puts them on top of another thing."),
        new EditorCommandDescriptor("map3d.raisesectortonearest", "Raise Floor/Ceiling/Thing to adjacent Sector/Thing", "PageUp", EditorCommandScope.Map3D, AllowScroll: true, DisregardAccelerator: true, Description: "Raises the targeted or selected floors/ceilings to match the height of adjacent sector. Hold Ctrl to raise to highest surface in selection. Also raises targeted or selected things to the nearest ceiling or floor or puts them on top of another thing."),
        new EditorCommandDescriptor("map3d.raise-brightness-8", "Increase Brightness by 8", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases the targeted or selected sector brightness level by 8."),
        new EditorCommandDescriptor("map3d.raisebrightness8", "Increase Brightness by 8", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Increases the targeted or selected sector brightness level by 8."),
        new EditorCommandDescriptor("map3d.lower-brightness-8", "Decrease Brightness by 8", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases the targeted or selected sector brightness level by 8."),
        new EditorCommandDescriptor("map3d.lowerbrightness8", "Decrease Brightness by 8", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Repeat: true, Description: "Decreases the targeted or selected sector brightness level by 8."),
        ...
        new EditorCommandDescriptor("map3d.brightness-down", "Sector brightness down", "[", EditorCommandScope.Map3D, Repeat: true, Description: "Decreases the targeted or selected sector brightness level by 8."),
        new EditorCommandDescriptor("map3d.brightness-up", "Sector brightness up", "]", EditorCommandScope.Map3D, Repeat: true, Description: "Increases the targeted or selected sector brightness level by 8."),
        ...
        new EditorCommandDescriptor("map3d.align-texture-x", "Align texture X", "A", EditorCommandScope.Map3D, AllowScroll: true, Description: "Automatically aligns the neighbouring textures X offsets until another texture is encountered."),
        new EditorCommandDescriptor("map3d.align-texture-y", "Align texture Y", "Shift+A", EditorCommandScope.Map3D, AllowScroll: true, Description: "Automatically aligns the neighbouring textures Y offsets until another texture is encountered. The Y alignment only takes the ceiling height for each sidedef into account."),
        ...
        new EditorCommandDescriptor("map3d.nudge-offset-left", "Nudge texture offset left", "Shift+Left", EditorCommandScope.Map3D, Repeat: true, Description: "Moves the offset of the targeted or selected textures to the left by 1 pixel."),
        new EditorCommandDescriptor("map3d.nudge-offset-right", "Nudge texture offset right", "Shift+Right", EditorCommandScope.Map3D, Repeat: true, Description: "Moves the offset of the targeted or selected textures to the right by 1 pixel."),
        new EditorCommandDescriptor("map3d.nudge-offset-up", "Nudge texture offset up", "Shift+Up", EditorCommandScope.Map3D, Repeat: true, Description: "Moves the offset of the targeted or selected textures up by 1 pixel."),
        new EditorCommandDescriptor("map3d.nudge-offset-down", "Nudge texture offset down", "Shift+Down", EditorCommandScope.Map3D, Repeat: true, Description: "Moves the offset of the targeted or selected textures down by 1 pixel."),
        ...
        new EditorCommandDescriptor("map3d.copy-properties", "Copy Properties", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Copies the targeted object properties for pasting."),
        new EditorCommandDescriptor("map3d.copyproperties", "Copy Properties", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Copies the targeted object properties for pasting."),
        new EditorCommandDescriptor("map3d.paste-properties", "Paste Properties", "Ctrl/Cmd+Alt+V", EditorCommandScope.Map3D, AllowScroll: true, Description: "Pastes the copied properties onto the targeted or selected object."),
        new EditorCommandDescriptor("map3d.pasteproperties", "Paste Properties", "Ctrl/Cmd+Alt+V", EditorCommandScope.Map3D, AllowScroll: true, Description: "Pastes the copied properties onto the targeted or selected object."),
        new EditorCommandDescriptor("map3d.paste-properties-options", "Paste Properties Special", "Ctrl/Cmd+Shift+V", EditorCommandScope.Map3D, AllowScroll: true, Description: "Pastes the copied properties onto the highlighted or selected objects allowing you to choose the properties to paste."),
        new EditorCommandDescriptor("map3d.pastepropertieswithoptions", "Paste Properties Special", "Ctrl/Cmd+Shift+V", EditorCommandScope.Map3D, AllowScroll: true, Description: "Pastes the copied properties onto the highlighted or selected objects allowing you to choose the properties to paste."),
        ...
        new EditorCommandDescriptor("map3d.toggle-slope", "Toggle Slope", "Alt+S", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles Slope for selected surfaces. Select or highlight upper/lower walls to add a slope. Select or highlight floors or ceilings to remove slope."),
        new EditorCommandDescriptor("map3d.toggleslope", "Toggle Slope", "Alt+S", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles Slope for selected surfaces. Select or highlight upper/lower walls to add a slope. Select or highlight floors or ceilings to remove slope."),
        new EditorCommandDescriptor("map3d.toggle-models-rendering", "Toggle models rendering", "Menu", EditorCommandScope.Map3D, Description: "Cycles through all models rendering modes in Classic and Visual modes."),
        new EditorCommandDescriptor("map3d.gztogglemodels", "Toggle models rendering", "Menu", EditorCommandScope.Map3D, Description: "Cycles through all models rendering modes in Classic and Visual modes."),
        new EditorCommandDescriptor("map3d.toggle-model-rendering", "Toggle Model Rendering Mode", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Cycles through all models rendering modes in Classic and Visual modes."),
        new EditorCommandDescriptor("map3d.toggle-dynamic-lights-rendering", "Toggle dynamic lights rendering", "Menu", EditorCommandScope.Map3D, Description: "Cycles through all dynamic light rendering modes in Visual mode."),
        new EditorCommandDescriptor("map3d.toggledynamiclightsrendering", "Toggle dynamic lights rendering", "Menu", EditorCommandScope.Map3D, Description: "Cycles through all dynamic light rendering modes in Visual mode."),
        new EditorCommandDescriptor("map3d.gztogglelights", "Toggle dynamic lights rendering", "Menu", EditorCommandScope.Map3D, Description: "Cycles through all dynamic light rendering modes in Visual mode."),
        new EditorCommandDescriptor("map3d.toggle-enhanced-rendering-effects", "Toggle Enhanced Rendering Effects", "Menu", EditorCommandScope.Map3D, Description: "Toggles enhanced rendering effects (slopes, 3D-floors, dynamic lights, fog, sky etc.) in Visual mode."),
        new EditorCommandDescriptor("map3d.gztoggleenhancedrendering", "Toggle Enhanced Rendering Effects", "Menu", EditorCommandScope.Map3D, Description: "Toggles enhanced rendering effects (slopes, 3D-floors, dynamic lights, fog, sky etc.) in Visual mode."),
        new EditorCommandDescriptor("map3d.toggle-classic-rendering", "Toggle classic rendering", "Menu", EditorCommandScope.Map3D, Description: "When enabled, attempts to simulate classic Doom rendering with banded light and palettized textures."),
        new EditorCommandDescriptor("map3d.toggleclassicrendering", "Toggle classic rendering", "Menu", EditorCommandScope.Map3D, Description: "When enabled, attempts to simulate classic Doom rendering with banded light and palettized textures."),
        new EditorCommandDescriptor("map3d.toggle-fog-rendering", "Toggle fog rendering", "Menu", EditorCommandScope.Map3D, Description: "Toggles fog rendering in Visual mode."),
        new EditorCommandDescriptor("map3d.togglefogrendering", "Toggle fog rendering", "Menu", EditorCommandScope.Map3D, Description: "Toggles fog rendering in Visual mode."),
        new EditorCommandDescriptor("map3d.gztogglefog", "Toggle fog rendering", "Menu", EditorCommandScope.Map3D, Description: "Toggles fog rendering in Visual mode."),
        new EditorCommandDescriptor("map3d.toggle-sky-rendering", "Toggle sky rendering", "Menu", EditorCommandScope.Map3D, Description: "Toggles sky rendering in Visual mode."),
        new EditorCommandDescriptor("map3d.toggleskyrendering", "Toggle sky rendering", "Menu", EditorCommandScope.Map3D, Description: "Toggles sky rendering in Visual mode."),
        new EditorCommandDescriptor("map3d.gztogglesky", "Toggle sky rendering", "Menu", EditorCommandScope.Map3D, Description: "Toggles sky rendering in Visual mode."),
        new EditorCommandDescriptor("map3d.toggle-event-lines", "Toggle Event lines", "Menu", EditorCommandScope.Map3D, AllowMouse: false, Description: "When enabled, shows order, in which patrol points and interpolation points are connected. Also shows action target for currently highlighted item in 2D modes."),
        new EditorCommandDescriptor("map3d.toggleeventlines", "Toggle Event lines", "Menu", EditorCommandScope.Map3D, AllowMouse: false, Description: "When enabled, shows order, in which patrol points and interpolation points are connected. Also shows action target for currently highlighted item in 2D modes."),
        new EditorCommandDescriptor("map3d.gztoggleeventlines", "Toggle Event lines", "Menu", EditorCommandScope.Map3D, AllowMouse: false, Description: "When enabled, shows order, in which patrol points and interpolation points are connected. Also shows action target for currently highlighted item in 2D modes."),
        new EditorCommandDescriptor("map3d.toggle-visual-vertices", "Toggle Visual Vertices", "Alt+V", EditorCommandScope.Map3D, AllowMouse: false, Description: "When enabled, shows vertices, which heights can be changed, in Visual mode (UDMF only)."),
        new EditorCommandDescriptor("map3d.togglevisualvertices", "Toggle Visual Vertices", "Alt+V", EditorCommandScope.Map3D, AllowMouse: false, Description: "When enabled, shows vertices, which heights can be changed, in Visual mode (UDMF only)."),
        new EditorCommandDescriptor("map3d.gztogglevisualvertices", "Toggle Visual Vertices", "Alt+V", EditorCommandScope.Map3D, AllowMouse: false, Description: "When enabled, shows vertices, which heights can be changed, in Visual mode (UDMF only)."),
        new EditorCommandDescriptor("map3d.toggle-alpha-based-texture-highlighting", "Toggle Alpha-based Texture Highlighting", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles Alpha-based Texture Highlighting. When enabled, 3d floor textures and middle textures on double-sided lines will be highlighted only when the crosshair points at a non-transparent pixel."),
        new EditorCommandDescriptor("map3d.alphabasedtexturehighlighting", "Toggle Alpha-based Texture Highlighting", "Menu", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles Alpha-based Texture Highlighting. When enabled, 3d floor textures and middle textures on double-sided lines will be highlighted only when the crosshair points at a non-transparent pixel."),
        new EditorCommandDescriptor("map3d.toggle-visual-sidedef-slope-picking", "Toggle Visual Sidedef Slope Picking", "Menu", EditorCommandScope.Map3D, Description: "Toggles picking visual sidedef slope handles."),
        new EditorCommandDescriptor("map3d.togglevisualslopepicking", "Toggle Visual Sidedef Slope Picking", "Menu", EditorCommandScope.Map3D, Description: "Toggles picking visual sidedef slope handles."),
        new EditorCommandDescriptor("map3d.toggle-visual-vertex-slope-picking", "Toggle Visual Vertex Slope Picking", "Menu", EditorCommandScope.Map3D, Description: "Toggles picking visual vertex slope handles."),
        new EditorCommandDescriptor("map3d.togglevisualvertexslopepicking", "Toggle Visual Vertex Slope Picking", "Menu", EditorCommandScope.Map3D, Description: "Toggles picking visual vertex slope handles."),
        new EditorCommandDescriptor("map3d.toggle-visual-vertex-slope-adjacent-selection", "Toggle Adjacent Visual Vertex Slope Selection", "Menu", EditorCommandScope.Map3D, Description: "Toggles selection of adjacent visual vertex slopes, so that selecting one visual vertex slope handle will select all adjacent visual vertex slope handles."),
        new EditorCommandDescriptor("map3d.togglevisualvertexslopeadjacentselection", "Toggle Adjacent Visual Vertex Slope Selection", "Menu", EditorCommandScope.Map3D, Description: "Toggles selection of adjacent visual vertex slopes, so that selecting one visual vertex slope handle will select all adjacent visual vertex slope handles."),
        new EditorCommandDescriptor("map3d.reset-slope", "Reset Plane Slope", "Menu", EditorCommandScope.Map3D, Description: "Resets UDMF slope applied to a floor/ceiling."),
        new EditorCommandDescriptor("map3d.resetslope", "Reset Plane Slope", "Menu", EditorCommandScope.Map3D, Description: "Resets UDMF slope applied to a floor/ceiling."),
        new EditorCommandDescriptor("map3d.raise-slope-handle-to-nearest", "Raise Slope Handle to Nearest", "Menu", EditorCommandScope.Map3D, Description: "Raises the selected visual slope handle to the nearest matching slope handle height."),
        new EditorCommandDescriptor("map3d.raiseslopehandletonearest", "Raise Slope Handle to Nearest", "Menu", EditorCommandScope.Map3D, Description: "Raises the selected visual slope handle to the nearest matching slope handle height."),
        new EditorCommandDescriptor("map3d.lower-slope-handle-to-nearest", "Lower Slope Handle to Nearest", "Menu", EditorCommandScope.Map3D, Description: "Lowers the selected visual slope handle to the nearest matching slope handle height."),
        new EditorCommandDescriptor("map3d.lowerslopehandletonearest", "Lower Slope Handle to Nearest", "Menu", EditorCommandScope.Map3D, Description: "Lowers the selected visual slope handle to the nearest matching slope handle height."),
        new EditorCommandDescriptor("map3d.slope-between-handles", "Slope Between Handles", "Menu", EditorCommandScope.Map3D, Description: "Slopes the selected floors and ceilings between the selected slope handles."),
        new EditorCommandDescriptor("map3d.slopebetweenhandles", "Slope Between Handles", "Menu", EditorCommandScope.Map3D, Description: "Slopes the selected floors and ceilings between the selected slope handles."),
        new EditorCommandDescriptor("map3d.arch-between-handles", "Arch Between Slope Handles", "Menu", EditorCommandScope.Map3D, Description: "Arches the selected floors and ceilings between the selected slope handles."),
        new EditorCommandDescriptor("map3d.archbetweenhandles", "Arch Between Slope Handles", "Menu", EditorCommandScope.Map3D, Description: "Arches the selected floors and ceilings between the selected slope handles."),
        new EditorCommandDescriptor("map3d.toggle-full-brightness", "Toggle Full Brightness", "B", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles the use of sector brightness on and off. When sector brightness is off, the world is displayed fully bright, without lighting effects."),
        new EditorCommandDescriptor("map3d.toggle-highlight", "Toggle Highlight", "H", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles the highlight of the targeted and selected objects."),
        new EditorCommandDescriptor("map3d.togglehighlight", "Toggle Highlight", "H", EditorCommandScope.Map3D, AllowScroll: true, Description: "Toggles the highlight of the targeted and selected objects."),
        new EditorCommandDescriptor("map3d.visual-select", "Select", "Click", EditorCommandScope.Map3D, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Selects the highlighted item. Hold Shift to select adjacent surfaces with the same texture. Hold Ctrl to select adjacent surfaces with the same height. Hold Alt to stop selecting adjacent surfaces when already selected surface is encountered."),
        new EditorCommandDescriptor("map3d.visualselect", "Select", "Click", EditorCommandScope.Map3D, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Selects the highlighted item. Hold Shift to select adjacent surfaces with the same texture. Hold Ctrl to select adjacent surfaces with the same height. Hold Alt to stop selecting adjacent surfaces when already selected surface is encountered."),
        new EditorCommandDescriptor("map3d.visual-paint-select", "Paint Selection", "Menu", EditorCommandScope.Map3D, AllowScroll: false, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Selects or deselects items by dragging the mouse. Hold shift while dragging to toggle additive selection. Hold Ctrl while dragging to enable subtractive selection"),
        new EditorCommandDescriptor("map3d.visualpaintselect", "Paint Selection", "Menu", EditorCommandScope.Map3D, AllowScroll: false, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Selects or deselects items by dragging the mouse. Hold shift while dragging to toggle additive selection. Hold Ctrl while dragging to enable subtractive selection"),
        new EditorCommandDescriptor("map3d.select-target", "Select surfaces", "Click", EditorCommandScope.Map3D, DisregardShift: true, DisregardAccelerator: true, DisregardAlt: true, Description: "Selects the highlighted item. Hold Shift to select adjacent surfaces with the same texture. Hold Ctrl to select adjacent surfaces with the same height. Hold Alt to stop selecting adjacent surfaces when already selected surface is encountered."),
        new EditorCommandDescriptor("map3d.clear-selection", "Clear Selection", "Esc", EditorCommandScope.Map3D, AllowScroll: true, Description: "Deselects all selected elements."),
        new EditorCommandDescriptor("map3d.clearselection", "Clear Selection", "Esc", EditorCommandScope.Map3D, AllowScroll: true, Description: "Deselects all selected elements."),
        new EditorCommandDescriptor("map3d.clear-target", "Clear selection", "Esc", EditorCommandScope.Map3D, Description: "Deselects all selected elements."),
