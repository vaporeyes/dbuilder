...
public static class EditorCommandCatalog
{
    public static IReadOnlyList<EditorCommandDescriptor> All { get; } = new[]
    {
        ...
        new EditorCommandDescriptor("window.deleteitem", "Remove selection", "Delete", EditorCommandScope.Window),
        ...
        new EditorCommandDescriptor("window.clearselection", "Select none", "Menu", EditorCommandScope.Window),
