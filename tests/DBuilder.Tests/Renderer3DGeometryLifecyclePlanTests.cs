...
public sealed class Renderer3DGeometryLifecyclePlanTests
{
    ...
    [Fact]
    public void BuildThingDrawStatePlanMatchesUdbPassSetupAndDrawUniforms()
    {
        Renderer3DThingDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(
                    1,
        ...
        Assert.Equal(ShaderName.world3d_main, plan.InitialShader);
        Assert.True(plan.ClampTextureAddress);
        Assert.Equal(Cull.None, plan.CullMode);
        Assert.True(plan.ResetStencilAfterTextureGroup);
        Assert.True(plan.WrapTextureAddressAfterThings);
        Assert.Equal(Cull.Clockwise, plan.RestoreCullModeAfterThings);

        Assert.Equal(
            [
                new Renderer3DThingDrawStatePlan(1, UpdateThing: true, CalculateCameraDistance: false, SkippedByDistance: false, HasGeometryBuffer: true, WantedShader: ShaderName.world3d_main, SwitchShader: false, SetModelNormalForFog: false, SetCameraFogUniform: false, VertexColorSource: Renderer3DThingVertexColorSource.None, SetSectorLightLevel: true, SectorBrightness: 128, SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff010203), SetVertexColor: true, SetHighlightColor: true, SetStencilColor: true, SetDesaturation: true, SectorDesaturation: 0.25, SetWorldMatrix: true, BindGeometryBuffer: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, StartIndex: 0, Triangles: 6),
                new Renderer3DThingDrawStatePlan(2, UpdateThing: true, CalculateCameraDistance: false, SkippedByDistance: false, HasGeometryBuffer: true, WantedShader: ShaderName.world3d_main_highlight_fog_vertexcolor, SwitchShader: true, SetModelNormalForFog: true, SetCameraFogUniform: true, VertexColorSource: Renderer3DThingVertexColorSource.InternalLight, SetSectorLightLevel: true, SectorBrightness: 160, SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff040506), SetVertexColor: true, SetHighlightColor: true, SetStencilColor: true, SetDesaturation: true, SectorDesaturation: 0.5, SetWorldMatrix: true, BindGeometryBuffer: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, StartIndex: 0, Triangles: 12),
            ],
            plan.Draws);
    }

    [Fact]
    public void BuildThingDrawStatePlanSkipsDistanceCulledThingsAfterUpdate()
    {
        Renderer3DThingDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(10.0, 0.0, 0.0), DistanceCheckSq: 25.0, HasGeometryBuffer: true, Highlighted: true, Selected: true, HasSector: true, SectorHasFog: true, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.25, FogFactor: 0.5, LightInternal: true, LightIsSun: false, DrawLights: true, HasDynamicLights: true, LitColorNonZero: true, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: true,
        ...
        Assert.Equal(
            [
                new Renderer3DThingDrawStatePlan(1, UpdateThing: true, CalculateCameraDistance: true, SkippedByDistance: true, HasGeometryBuffer: true, WantedShader: null, SwitchShader: false, SetModelNormalForFog: false, SetCameraFogUniform: false, VertexColorSource: Renderer3DThingVertexColorSource.None, SetSectorLightLevel: false, SectorBrightness: null, SetSectorFogColor: false, SectorFogColor: null, SetVertexColor: false, SetHighlightColor: false, SetStencilColor: false, SetDesaturation: false, SectorDesaturation: 0.0, SetWorldMatrix: false, BindGeometryBuffer: false, Draw: false, PrimitiveType: PrimitiveType.TriangleList, StartIndex: 0, Triangles: 0),
            ],
            plan.Draws);
    }

    [Fact]
    public void BuildThingDrawStatePlanSkipsDrawWhenGeometryBufferIsMissing()
    {
        Renderer3DThingDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(1.0, 0.0, 0.0), DistanceCheckSq: double.MaxValue, HasGeometryBuffer: false, Highlighted: true, Selected: true, HasSector: true, SectorHasFog: true, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.25, FogFactor: 0.5, LightInternal: true, LightIsSun: false, DrawLights: true, HasDynamicLights: true, LitColorNonZero: true, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: true,
        ...
        Renderer3DThingDrawStatePlan draw = Assert.Single(plan.Draws);
        Assert.True(draw.UpdateThing);
        Assert.False(draw.SkippedByDistance);
        Assert.False(draw.HasGeometryBuffer);
        Assert.False(draw.Draw);
        Assert.False(draw.SetWorldMatrix);
        Assert.False(draw.BindGeometryBuffer);
    }

    [Fact]
    public void BuildThingDrawStatePlanUsesDynamicLightVertexColorAndZeroDesaturationWithoutSector()
    {
        Renderer3DThingDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(1.0, 0.0, 0.0), DistanceCheckSq: double.MaxValue, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: false, SectorHasFog: false, SectorBrightness: 0, SectorFogColor: 0, SectorDesaturation: 0.75, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: true, HasDynamicLights: true, LitColorNonZero: true, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: true,
        ...
        Renderer3DThingDrawStatePlan draw = Assert.Single(plan.Draws);
        Assert.Equal(ShaderName.world3d_main_vertexcolor, draw.WantedShader);
        Assert.Equal(Renderer3DThingVertexColorSource.DynamicLight, draw.VertexColorSource);
        Assert.False(draw.SetSectorLightLevel);
        Assert.Null(draw.SectorBrightness);
        Assert.False(draw.SetSectorFogColor);
        Assert.Null(draw.SectorFogColor);
        Assert.True(draw.SetDesaturation);
        Assert.Equal(0.0, draw.SectorDesaturation);
    }

    [Fact]
    public void BuildThingDrawStatePlanRejectsInvalidInputs()
    {
        Assert.Throws<ArgumentNullException>(() => Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(null!, new Vector3D(), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan([], new Vector3D(double.NaN, 0.0, 0.0), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(double.NaN, 0.0, 0.0), DistanceCheckSq: double.MaxValue, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(), DistanceCheckSq: -1.0, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(), DistanceCheckSq: double.MaxValue, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: double.NaN, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildThingDrawStatePlan(
            [
                new Renderer3DThingDrawStateCandidate(1, new Vector3D(), DistanceCheckSq: double.MaxValue, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: double.PositiveInfinity, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
    ...
    [Fact]
    public void BuildTranslucentGeometryDrawStatePlanMatchesUdbBlendTextureFogAndDrawRules()
    {
        Renderer3DTranslucentGeometryDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan(
            [
                new Renderer3DTranslucentGeometryDrawStateCandidate(1, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(4.0, 0.0, 0.0), RenderPass.Alpha, TextureLongName: 100, DrawPaletted: false, SectorId: 10, SectorNeedsUpdate: true, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: true, SectorFogColor: unchecked((int)0xff010203), SectorDesaturation: 0.25, FogFactor: 0.5, Skew: new Vector2f(1.0f, 2.0f), VertexOffset: 4, Triangles: 6),
                new Renderer3DTranslucentGeometryDrawStateCandidate(2, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(3.0, 0.0, 0.0), RenderPass.Alpha, TextureLongName: 100, DrawPaletted: false, SectorId: 10, SectorNeedsUpdate: true, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: true, Selected: false, SectorHasFog: true, SectorFogColor: unchecked((int)0xff040506), SectorDesaturation: 0.5, FogFactor: 0.5, Skew: new Vector2f(3.0f, 4.0f), VertexOffset: 10, Triangles: 12),
                new Renderer3DTranslucentGeometryDrawStateCandidate(3, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(2.0, 0.0, 0.0), RenderPass.Additive, TextureLongName: 200, DrawPaletted: true, SectorId: 20, SectorNeedsUpdate: false, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: false, SectorFogColor: unchecked((int)0xff070809), SectorDesaturation: 0.75, FogFactor: 0.0, Skew: new Vector2f(5.0f, 6.0f), VertexOffset: 22, Triangles: 24),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: true,
        ...
        Assert.Equal(
            [
                new Renderer3DTranslucentGeometryDrawStatePlan(1, RenderPass.Alpha, Blend.InverseSourceAlpha, SetTexture: true, TextureLongName: 100, DrawPaletted: false, UpdateSectorGeometry: true, BindSectorGeometryBuffer: true, ClearCurrentSector: false, WantedShader: ShaderName.world3d_main_fog, SwitchShader: true, SetModelNormalForFog: true, SetCameraFogUniform: true, FogFactor: 0.5, SetDesaturation: true, SectorDesaturation: 0.25, SetSkew: true, Skew: new Vector2f(1.0f, 2.0f), SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff010203), SetHighlightColor: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, VertexOffset: 4, Triangles: 6),
                new Renderer3DTranslucentGeometryDrawStatePlan(2, RenderPass.Alpha, DestinationBlendChange: null, SetTexture: false, TextureLongName: null, DrawPaletted: null, UpdateSectorGeometry: false, BindSectorGeometryBuffer: false, ClearCurrentSector: false, WantedShader: ShaderName.world3d_main_highlight_fog, SwitchShader: true, SetModelNormalForFog: true, SetCameraFogUniform: false, FogFactor: null, SetDesaturation: true, SectorDesaturation: 0.5, SetSkew: true, Skew: new Vector2f(3.0f, 4.0f), SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff040506), SetHighlightColor: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, VertexOffset: 10, Triangles: 12),
                new Renderer3DTranslucentGeometryDrawStatePlan(3, RenderPass.Additive, Blend.One, SetTexture: true, TextureLongName: 200, DrawPaletted: true, UpdateSectorGeometry: false, BindSectorGeometryBuffer: true, ClearCurrentSector: false, WantedShader: ShaderName.world3d_main, SwitchShader: true, SetModelNormalForFog: false, SetCameraFogUniform: false, FogFactor: null, SetDesaturation: true, SectorDesaturation: 0.75, SetSkew: true, Skew: new Vector2f(5.0f, 6.0f), SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff070809), SetHighlightColor: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, VertexOffset: 22, Triangles: 24),
            ],
            plan.Draws);
    }

    [Fact]
    public void BuildTranslucentGeometryDrawStatePlanUsesPlaneOrderingAndClearsUnavailableSectors()
    {
        Renderer3DTranslucentGeometryDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan(
            [
                new Renderer3DTranslucentGeometryDrawStateCandidate(1, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(100.0, 0.0, 1.0), RenderPass.Alpha, TextureLongName: 100, DrawPaletted: false, SectorId: 10, SectorNeedsUpdate: false, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: false, SectorFogColor: 0, SectorDesaturation: 0.25, FogFactor: 0.0, Skew: new Vector2f(), VertexOffset: 4, Triangles: 6),
                new Renderer3DTranslucentGeometryDrawStateCandidate(2, Renderer3DVisualGeometryType.Floor, new Vector3D(1.0, 0.0, 20.0), RenderPass.Alpha, TextureLongName: 200, DrawPaletted: false, SectorId: 20, SectorNeedsUpdate: true, SectorHasGeometryBuffer: false, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: false, SectorFogColor: 0, SectorDesaturation: 0.5, FogFactor: 0.0, Skew: new Vector2f(), VertexOffset: 10, Triangles: 12),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Equal([2, 1], plan.Draws.Select(draw => draw.GeometryId).ToArray());
        Assert.False(plan.LightsEnabled);
        Assert.True(plan.Draws[0].ClearCurrentSector);
        Assert.True(plan.Draws[0].SetDesaturation);
        Assert.Equal(0.0, plan.Draws[0].SectorDesaturation);
        Assert.False(plan.Draws[0].Draw);
        Assert.True(plan.Draws[1].Draw);
    }

    [Fact]
    public void BuildTranslucentGeometryDrawStatePlanRejectsInvalidInputs()
    {
        Assert.Throws<ArgumentNullException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan(null!, new Vector3D(), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true, lightCount: 0, inverseSquareLightAttenuation: false));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan([], new Vector3D(double.NaN, 0.0, 0.0), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true, lightCount: 0, inverseSquareLightAttenuation: false));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan([], new Vector3D(), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true, lightCount: -1, inverseSquareLightAttenuation: false));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan(
            [
                new Renderer3DTranslucentGeometryDrawStateCandidate(1, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(double.NaN, 0.0, 0.0), RenderPass.Alpha, TextureLongName: 100, DrawPaletted: false, SectorId: 10, SectorNeedsUpdate: false, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: false, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, Skew: new Vector2f(), VertexOffset: 4, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan(
            [
                new Renderer3DTranslucentGeometryDrawStateCandidate(1, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(), RenderPass.Alpha, TextureLongName: 100, DrawPaletted: false, SectorId: 10, SectorNeedsUpdate: false, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: false, SectorFogColor: 0, SectorDesaturation: double.NaN, FogFactor: 0.0, Skew: new Vector2f(), VertexOffset: 4, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentGeometryDrawStatePlan(
            [
                new Renderer3DTranslucentGeometryDrawStateCandidate(1, Renderer3DVisualGeometryType.WallMiddle, new Vector3D(), RenderPass.Alpha, TextureLongName: 100, DrawPaletted: false, SectorId: 10, SectorNeedsUpdate: false, SectorHasGeometryBuffer: true, SectorHasMap: true, Highlighted: false, Selected: false, SectorHasFog: false, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, Skew: new Vector2f(), VertexOffset: -1, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
    ...
    [Fact]
    public void BuildTranslucentThingDrawStatePlanMatchesUdbSpriteTextureFogAndDrawRules()
    {
        Renderer3DTranslucentThingDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan(
            [
                new Renderer3DTranslucentThingDrawStateCandidate(1, new Vector3D(4.0, 0.0, 0.0), RenderPass.Alpha, DistanceCheckSq: double.MaxValue, TextureLongName: 100, DrawPaletted: false, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: true, SectorBrightness: 128, SectorFogColor: unchecked((int)0xff010203), SectorDesaturation: 0.25, FogFactor: 0.5, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 6),
                new Renderer3DTranslucentThingDrawStateCandidate(2, new Vector3D(3.0, 0.0, 0.0), RenderPass.Alpha, DistanceCheckSq: double.MaxValue, TextureLongName: 100, DrawPaletted: false, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: true, Selected: false, HasSector: true, SectorHasFog: true, SectorBrightness: 160, SectorFogColor: unchecked((int)0xff040506), SectorDesaturation: 0.5, FogFactor: 0.5, LightInternal: true, LightIsSun: false, DrawLights: true, HasDynamicLights: true, LitColorNonZero: true, Triangles: 12),
                new Renderer3DTranslucentThingDrawStateCandidate(3, new Vector3D(2.0, 0.0, 0.0), RenderPass.Additive, DistanceCheckSq: double.MaxValue, TextureLongName: 200, DrawPaletted: true, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 192, SectorFogColor: unchecked((int)0xff070809), SectorDesaturation: 0.75, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: true, HasDynamicLights: true, LitColorNonZero: true, Triangles: 24),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: true,
        ...
        Assert.Equal(
            [
                new Renderer3DTranslucentThingDrawStatePlan(1, RenderPass.Alpha, UpdateThing: true, CalculateCameraDistance: false, SkippedByDistance: false, UpdateSpriteFrame: true, SkipUnknownTexture: false, DestinationBlendChange: Blend.InverseSourceAlpha, SetTexture: true, TextureLongName: 100, DrawPaletted: false, HasGeometryBuffer: true, WantedShader: ShaderName.world3d_main_fog, SwitchShader: true, SetModelNormalForFog: true, SetCameraFogUniform: true, FogFactor: 0.5, VertexColorSource: Renderer3DThingVertexColorSource.None, SetSectorLightLevel: true, SectorBrightness: 128, SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff010203), SetVertexColor: true, SetHighlightColor: true, SetStencilColor: true, SetDesaturation: true, SectorDesaturation: 0.25, SetWorldMatrix: true, BindGeometryBuffer: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, StartIndex: 0, Triangles: 6),
                new Renderer3DTranslucentThingDrawStatePlan(2, RenderPass.Alpha, UpdateThing: true, CalculateCameraDistance: false, SkippedByDistance: false, UpdateSpriteFrame: true, SkipUnknownTexture: false, DestinationBlendChange: null, SetTexture: false, TextureLongName: null, DrawPaletted: null, HasGeometryBuffer: true, WantedShader: ShaderName.world3d_main_highlight_fog_vertexcolor, SwitchShader: true, SetModelNormalForFog: true, SetCameraFogUniform: false, FogFactor: null, VertexColorSource: Renderer3DThingVertexColorSource.InternalLight, SetSectorLightLevel: true, SectorBrightness: 160, SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff040506), SetVertexColor: true, SetHighlightColor: true, SetStencilColor: true, SetDesaturation: true, SectorDesaturation: 0.5, SetWorldMatrix: true, BindGeometryBuffer: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, StartIndex: 0, Triangles: 12),
                new Renderer3DTranslucentThingDrawStatePlan(3, RenderPass.Additive, UpdateThing: true, CalculateCameraDistance: false, SkippedByDistance: false, UpdateSpriteFrame: true, SkipUnknownTexture: false, DestinationBlendChange: Blend.One, SetTexture: true, TextureLongName: 200, DrawPaletted: true, HasGeometryBuffer: true, WantedShader: ShaderName.world3d_main_vertexcolor, SwitchShader: true, SetModelNormalForFog: false, SetCameraFogUniform: false, FogFactor: null, VertexColorSource: Renderer3DThingVertexColorSource.DynamicLight, SetSectorLightLevel: true, SectorBrightness: 192, SetSectorFogColor: true, SectorFogColor: unchecked((int)0xff070809), SetVertexColor: true, SetHighlightColor: true, SetStencilColor: true, SetDesaturation: true, SectorDesaturation: 0.75, SetWorldMatrix: true, BindGeometryBuffer: true, Draw: true, PrimitiveType: PrimitiveType.TriangleList, StartIndex: 0, Triangles: 24),
            ],
            plan.Draws);
    }

    [Fact]
    public void BuildTranslucentThingDrawStatePlanSkipsDistanceUnknownTextureAndMissingBuffer()
    {
        Renderer3DTranslucentThingDrawStatePlanSet plan = Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan(
            [
                new Renderer3DTranslucentThingDrawStateCandidate(1, new Vector3D(30.0, 0.0, 0.0), RenderPass.Alpha, DistanceCheckSq: 25.0, TextureLongName: 100, DrawPaletted: false, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 6),
                new Renderer3DTranslucentThingDrawStateCandidate(2, new Vector3D(20.0, 0.0, 0.0), RenderPass.Alpha, DistanceCheckSq: double.MaxValue, TextureLongName: 200, DrawPaletted: false, HasUnknownTexture: true, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 6),
                new Renderer3DTranslucentThingDrawStateCandidate(3, new Vector3D(10.0, 0.0, 0.0), RenderPass.Additive, DistanceCheckSq: double.MaxValue, TextureLongName: 300, DrawPaletted: true, HasUnknownTexture: false, HasGeometryBuffer: false, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 6),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Equal([1, 2, 3], plan.Draws.Select(draw => draw.ThingId).ToArray());
        Assert.True(plan.Draws[0].SkippedByDistance);
        Assert.False(plan.Draws[0].UpdateSpriteFrame);
        Assert.True(plan.Draws[1].UpdateSpriteFrame);
        Assert.True(plan.Draws[1].SkipUnknownTexture);
        Assert.False(plan.Draws[2].HasGeometryBuffer);
        Assert.Equal(Blend.One, plan.Draws[2].DestinationBlendChange);
        Assert.True(plan.Draws[2].SetTexture);
        Assert.False(plan.Draws[2].Draw);
    }

    [Fact]
    public void BuildTranslucentThingDrawStatePlanRejectsInvalidInputs()
    {
        Assert.Throws<ArgumentNullException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan(null!, new Vector3D(), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan([], new Vector3D(double.NaN, 0.0, 0.0), fullBrightness: false, drawFog: false, classicRendering: false, showHighlight: true, showSelection: true));
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan(
            [
                new Renderer3DTranslucentThingDrawStateCandidate(1, new Vector3D(double.NaN, 0.0, 0.0), RenderPass.Alpha, DistanceCheckSq: double.MaxValue, TextureLongName: 100, DrawPaletted: false, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan(
            [
                new Renderer3DTranslucentThingDrawStateCandidate(1, new Vector3D(), RenderPass.Alpha, DistanceCheckSq: -1.0, TextureLongName: 100, DrawPaletted: false, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: 0.0, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Renderer3DGeometryLifecyclePlan.BuildTranslucentThingDrawStatePlan(
            [
                new Renderer3DTranslucentThingDrawStateCandidate(1, new Vector3D(), RenderPass.Alpha, DistanceCheckSq: double.MaxValue, TextureLongName: 100, DrawPaletted: false, HasUnknownTexture: false, HasGeometryBuffer: true, Highlighted: false, Selected: false, HasSector: true, SectorHasFog: false, SectorBrightness: 128, SectorFogColor: 0, SectorDesaturation: double.NaN, FogFactor: 0.0, LightInternal: false, LightIsSun: false, DrawLights: false, HasDynamicLights: false, LitColorNonZero: false, Triangles: 1),
            ],
            new Vector3D(),
            fullBrightness: false,
            drawFog: false,
    ...
    public void Renderer3DStartGeometryExpressionsMatchUdbWhenCloneIsAvailable()
    {
        ...
        Assert.Contains("if (thingspass.Count > 0)", source, StringComparison.Ordinal);
        ...
        Assert.Contains("t.CalculateCameraDistance(cameraposition);", source, StringComparison.Ordinal);
        Assert.Contains("if (t.GeometryBuffer != null)", source, StringComparison.Ordinal);
        Assert.Contains("world = CreateThingPositionMatrix(t);", source, StringComparison.Ordinal);
        ...
        Assert.Contains("Color4 litcolor = GetLitColorForThing(t);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.campos, new Vector4f((float)cameraposition.x, (float)cameraposition.y, (float)cameraposition.z, t.FogFactor));", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.vertexColor, vertexcolor);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.stencilColor, t.StencilColor.ToColorValue());", source, StringComparison.Ordinal);
        Assert.Contains("else graphics.SetUniform(UniformName.desaturation, 0.0f);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.world, world);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetVertexBuffer(t.GeometryBuffer);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.Draw(PrimitiveType.TriangleList, 0, t.Triangles);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.stencilColor, new Color4(1f, 1f, 1f, 0f));", source, StringComparison.Ordinal);
        ...
        Assert.Contains("if(g.Texture.LongName != curtexturename)", source, StringComparison.Ordinal);
        Assert.Contains("curtexturename = g.Texture.LongName;", source, StringComparison.Ordinal);
        Assert.Contains("if(!object.ReferenceEquals(g.Sector, sector))", source, StringComparison.Ordinal);
        Assert.Contains("if (wantedshaderpass > ShaderName.world3d_p7 && g.FogFactor != fogfactor)", source, StringComparison.Ordinal);
        Assert.Contains("fogfactor = g.FogFactor;", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.desaturation, (float)sector.Sector.Desaturation);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.skew, g.Skew);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.sectorfogcolor, sector.Sector.FogColor);", source, StringComparison.Ordinal);
        Assert.Contains("else graphics.SetUniform(UniformName.desaturation, 0.0f);", source, StringComparison.Ordinal);
        ...
        Assert.Contains("t.UpdateSpriteFrame(); // Set correct texture, geobuffer and triangles count", source, StringComparison.Ordinal);
        Assert.Contains("if(t.Texture is UnknownImage) continue;", source, StringComparison.Ordinal);
        Assert.Contains("if(t.RenderPass != currentpass)", source, StringComparison.Ordinal);
        Assert.Contains("if(t.Texture.LongName != curtexturename)", source, StringComparison.Ordinal);
        Assert.Contains("curtexturename = t.Texture.LongName;", source, StringComparison.Ordinal);
        Assert.Contains("if(t.GeometryBuffer != null)", source, StringComparison.Ordinal);
        Assert.Contains("world = CreateThingPositionMatrix(t);", source, StringComparison.Ordinal);
        Assert.Contains("if(wantedshaderpass > ShaderName.world3d_p7)", source, StringComparison.Ordinal);
        Assert.Contains("if (t.FogFactor != fogfactor)", source, StringComparison.Ordinal);
        Assert.Contains("fogfactor = t.FogFactor;", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.world, world);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetVertexBuffer(t.GeometryBuffer);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.Draw(PrimitiveType.TriangleList, 0, t.Triangles);", source, StringComparison.Ordinal);
        Assert.Contains("graphics.SetUniform(UniformName.stencilColor, new Color4(1f, 1f, 1f, 0f));", source, StringComparison.Ordinal);
