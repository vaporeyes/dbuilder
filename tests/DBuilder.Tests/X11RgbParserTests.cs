...
// ABOUTME: Covers canonical names, multi-word names, comments, and malformed row skipping.
...
# also skipped";
        ...
        Assert.Equal(new X11Color("ghostwhite", 248, 248, 255), rgb.Colors["ghostwhite"]);
        Assert.False(rgb.Colors.ContainsKey("ghost white"));
