...
public class MapSetCloneTests
{
    ...
    public void ClonePreservesElementDataAndTransientState()
    {
        ...
        Assert.Equal(101, clone.Sectors[0].LongFloorTexture);
        Assert.Equal(102, clone.Sectors[0].LongCeilTexture);
        ...
        Assert.Equal(201, clone.Sidedefs[0].LongMiddleTexture);
    ...
    public void CloneIsIndependentFromOriginalMutations()
    {
        ...
        map.Sectors[0].LongFloorTexture = 999;
        map.Linedefs[0].SetArg(2, 1);
        map.Sidedefs[0].MidTexture = "CHANGED";
        map.Sidedefs[0].LongMiddleTexture = 999;
    ...
    public void CopyPropertiesToCopiesElementDataWithoutTopologyLinks()
    {
        ...
        Assert.Equal(sample.Sidedefs[0].LongMiddleTexture, side.LongMiddleTexture);
        ...
        Assert.Equal(sample.Sectors[0].LongFloorTexture, sector.LongFloorTexture);
    ...
    private static MapSet BuildSample()
    {
        ...
        frontSector.LongFloorTexture = 101;
        frontSector.LongCeilTexture = 102;
