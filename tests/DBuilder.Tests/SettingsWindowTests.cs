...
public class SettingsWindowTests
{
    ...
    public void SettingsWindowExposesShowEventLinesPreference()
    {
        ...
        Assert.NotNull(type.GetField("ShowLightRadii", BindingFlags.Instance | BindingFlags.Public));
        Assert.NotNull(type.GetField("ShowSoundRadii", BindingFlags.Instance | BindingFlags.Public));
        ...
        Assert.Contains("AddCheckBox(\"Show light radii\", s.ShowLightRadii)", body, StringComparison.Ordinal);
        Assert.Contains("AddCheckBox(\"Show sound radii\", s.ShowSoundRadii)", body, StringComparison.Ordinal);
        ...
        Assert.Contains("ShowLightRadii = _showLightRadii.IsChecked == true;", body, StringComparison.Ordinal);
        Assert.Contains("ShowSoundRadii = _showSoundRadii.IsChecked == true;", body, StringComparison.Ordinal);
        ...
        Assert.Contains("_settings.ShowLightRadii = dlg.ShowLightRadii;", mainWindow, StringComparison.Ordinal);
        Assert.Contains("_settings.ShowSoundRadii = dlg.ShowSoundRadii;", mainWindow, StringComparison.Ordinal);
        ...
        Assert.Contains("MapView.SetShowLightRadii(_settings.ShowLightRadii);", mainWindow, StringComparison.Ordinal);
        Assert.Contains("MapView.SetShowSoundRadii(_settings.ShowSoundRadii);", mainWindow, StringComparison.Ordinal);
    ...
    public void SettingsWindowExposesRenderQualityPreferences()
    {
        ...
        Assert.NotNull(type.GetField("MouseSelectionThreshold", BindingFlags.Instance | BindingFlags.Public));
        ...
        Assert.Contains("AddField(\"Mouse selection threshold\", Settings.MouseSelectionThresholdText(s))", body, StringComparison.Ordinal);
        ...
        Assert.Contains("MouseSelectionThreshold = Settings.AcceptMouseSelectionThresholdText(_mouseSelectionThreshold.Text);", body, StringComparison.Ordinal);
        ...
        Assert.Contains("_settings.MouseSelectionThreshold = dlg.MouseSelectionThreshold;", mainWindow, StringComparison.Ordinal);
        ...
        Assert.Contains("MapView.MouseSelectionThreshold = _settings.NormalizedMouseSelectionThreshold;", mainWindow, StringComparison.Ordinal);
