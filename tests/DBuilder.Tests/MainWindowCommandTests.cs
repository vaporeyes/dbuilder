...
{
    [Theory]
    [InlineData("window.newmap", "OnNewMap")]
    [InlineData("window.openmap", "OnOpen")]
    [InlineData("window.openmapincurrentwad", "OnOpenMap")]
    [InlineData("window.recover-autosave", "OnRecoverAutosave")]
    [InlineData("window.reload-map", "OnReloadMap")]
    [InlineData("window.closemap", "OnCloseMap")]
    [InlineData("window.add-resource", "OnAddResource")]
    [InlineData("window.add-resource-directory", "OnAddResourceDirectory")]
    [InlineData("window.savemap", "OnSave")]
    [InlineData("window.savemapas", "OnSaveAs")]
    [InlineData("window.save-as-format", "OnSaveAsFormat")]
    [InlineData("window.savemapinto", "OnSaveAsFormat")]
    [InlineData("window.mapoptions", "OnMapOptions")]
    ...
    [InlineData("window.viewusedtags", "OnTagStatistics")]
    ...
    [InlineData("window.viewthingtypes", "OnThingStatistics")]
    ...
    [InlineData("window.toggleinfopanel", "OnToggleInfoPanel")]
    ...
    [InlineData("window.toggleautoclearsidetextures", "OnToggleAutoClearSidedefTextures")]
    ...
    [InlineData("window.testmap", "OnTestMap")]
    ...
    [InlineData("window.gzreloadmodeldef", "OnReloadResources")]
    [InlineData("window.gzreloadgldefs", "OnReloadResources")]
    ...
    public void ClassicThingRenderTogglesPersistLikeUdb()
    {
        ...
        Assert.Contains("MapView.AutoDrawOnEdit = _settings.AutoDrawOnEdit;", code, StringComparison.Ordinal);
        ...
        Assert.Contains("MapView.MoveSpeed = _settings.NormalizedMoveSpeed;", code, StringComparison.Ordinal);
        Assert.Contains("MapView.MouseSpeed = _settings.NormalizedMouseSpeed;", code, StringComparison.Ordinal);
        Assert.Contains("MapView.MouseSelectionThreshold = _settings.NormalizedMouseSelectionThreshold;", code, StringComparison.Ordinal);
        Assert.Contains("MapView.StitchRange = _settings.NormalizedStitchRange;", code, StringComparison.Ordinal);
    ...
    public void EditMenuTooltipsRefreshFromEffectiveShortcutBindings()
    {
        ...
        Assert.Contains("SetShortcutToolTip(PastePropertiesOptionsMenuItem, \"Paste Properties Special\", \"window.classicpastepropertieswithoptions\");", body, StringComparison.Ordinal);
    ...
    public void CommandPaletteUsabilityFollowsMenuAvailabilityWhenAvailable()
    {
        ...
        Assert.Contains("\"window.linedefcolorssetup\" => LinedefColorSetupButton", code, StringComparison.Ordinal);
        Assert.DoesNotContain("\"window.linedefcolorssetup\" => ThingFilterMenuItem", code, StringComparison.Ordinal);
