...
public class RendererArchitectureModelTests
{
    ...
    public void CurrentContractDocumentsSilkNetOpenGlReplacement()
    {
        ...
        Assert.Contains("2D presentation planner input validation planning", replacement.CoveredResponsibilities);
        ...
        Assert.Contains("Renderer2D brightness color planning", replacement.CoveredResponsibilities);
        ...
        Assert.Contains("Renderer2D thing render overload routing planning", replacement.CoveredResponsibilities);
        ...
        Assert.Contains("Text label missing-texture recovery planning", replacement.CoveredResponsibilities);
